//2a14d7d40f75881362f1ab21fb75871

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : BuildSPARQLSearch_resp.java
 ...
 * @version 1.0
 */
public class BuildSPARQLSearch_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public BuildSPARQLSearch_resp(BuildSPARQLSearch_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(BuildSPARQLSearch_resp object) {
     ...
     * @param    sparql    
     */
    public BuildSPARQLSearch_resp(String sparql) {
        setSparql(sparql);
    }
    ...
    public String toString() {
        return this.toXML("BuildSPARQLSearch_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BuildSPARQLSearch_resp)) {
            return false;
        }
        BuildSPARQLSearch_resp value = (BuildSPARQLSearch_resp)obj;
     ...
     */
    public static boolean equals(BuildSPARQLSearch_resp[] __array1,BuildSPARQLSearch_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'BuildSPARQLSearch_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"BuildSPARQLSearch_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<BuildSPARQLSearch_resp type=\"BuildSPARQLSearch_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</BuildSPARQLSearch_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new BuildSPARQLSearch_resp(this);
    }
    /**
