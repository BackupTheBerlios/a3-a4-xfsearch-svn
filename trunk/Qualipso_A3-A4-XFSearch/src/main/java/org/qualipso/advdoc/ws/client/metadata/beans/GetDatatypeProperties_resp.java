//3298464255b655eb873d19de7a5399ae

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetDatatypeProperties_resp.java
 ...
 * @version 1.0
 */
public class GetDatatypeProperties_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetDatatypeProperties_resp() {
     ...
     */
    public GetDatatypeProperties_resp(GetDatatypeProperties_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetDatatypeProperties_resp object) {
     ...
     * @param    properties    
     */
    public GetDatatypeProperties_resp(org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[] properties) {
    ...
    public String toString() {
        return this.toXML("GetDatatypeProperties_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetDatatypeProperties_resp)) {
            return false;
        }
        GetDatatypeProperties_resp value = (GetDatatypeProperties_resp)obj;
     ...
     */
    public static boolean equals(GetDatatypeProperties_resp[] __array1,GetDatatypeProperties_resp[] __array2) {
...
public     boolean removeProperties(int position) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetDatatypeProperties_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetDatatypeProperties_resp\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetDatatypeProperties_resp type=\"GetDatatypeProperties_resp\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetDatatypeProperties_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetDatatypeProperties_resp(this);
    }
    /**
    ...
    public void copyFrom(Object source) throws ClassCastException {
        if (!(source instanceof GetDatatypeProperties_resp)) {
            throw new ClassCastException(getClass().getName()+".copyFrom() El objeto de copia es de la clase "+source.getClass().getName());
        }
        GetDatatypeProperties_resp bean = (GetDatatypeProperties_resp)source;
        this.set(bean);
    }
