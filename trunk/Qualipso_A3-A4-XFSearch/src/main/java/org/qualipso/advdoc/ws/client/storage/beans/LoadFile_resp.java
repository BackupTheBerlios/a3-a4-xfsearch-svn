//49dd217e9087344ef506ff8f1b0e9e

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : LoadFile_resp.java
 ...
 * @version 1.0
 */
public class LoadFile_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public LoadFile_resp(LoadFile_resp object) {
        this.set(object);
    }
    ...
    public String toString() {
        return this.toXML("LoadFile_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof LoadFile_resp)) {
            return false;
        }
        LoadFile_resp value = (LoadFile_resp)obj;
     ...
     */
    public static boolean equals(LoadFile_resp[] __array1,LoadFile_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'LoadFile_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"LoadFile_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<LoadFile_resp type=\"LoadFile_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
