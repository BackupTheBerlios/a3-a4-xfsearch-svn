//e58f64a6eda413b99699b710ff359db1

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : LoadBinaryFile_req.java
 ...
 * @version 1.0
 */
public class LoadBinaryFile_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public LoadBinaryFile_req(LoadBinaryFile_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(LoadBinaryFile_req object) {
     ...
     * @param    path    
     */
    public LoadBinaryFile_req(org.qualipso.advdoc.ws.client.storage.beans.FolderPath path,String filename) {
    ...
    public String toString() {
        return this.toXML("LoadBinaryFile_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof LoadBinaryFile_req)) {
            return false;
        }
        LoadBinaryFile_req value = (LoadBinaryFile_req)obj;
     ...
     */
    public static boolean equals(LoadBinaryFile_req[] __array1,LoadBinaryFile_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'LoadBinaryFile_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"LoadBinaryFile_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<LoadBinaryFile_req type=\"LoadBinaryFile_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</LoadBinaryFile_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new LoadBinaryFile_req(this);
    }
    /**
