//83f2c4dfe92921512425383be25cfc

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetEquivalentClasses_req.java
 ...
 * @version 1.0
 */
public class GetEquivalentClasses_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetEquivalentClasses_req() {
     ...
     */
    public GetEquivalentClasses_req(GetEquivalentClasses_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetEquivalentClasses_req object) {
     ...
     * @param    classUri    
     */
    public GetEquivalentClasses_req(String classUri) {
    ...
    public String toString() {
        return this.toXML("GetEquivalentClasses_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetEquivalentClasses_req)) {
            return false;
        }
        GetEquivalentClasses_req value = (GetEquivalentClasses_req)obj;
     ...
     */
    public static boolean equals(GetEquivalentClasses_req[] __array1,GetEquivalentClasses_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetEquivalentClasses_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetEquivalentClasses_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetEquivalentClasses_req type=\"GetEquivalentClasses_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetEquivalentClasses_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetEquivalentClasses_req(this);
    }
    /**
