//80429a5deefa2c413bf5319a14b8301f

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenAddLiteralPropertiesService.java
...
/**
 * Clase base para la operación AddLiteralProperties : Add some literal properties to an existing resource
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenAddLiteralPropertiesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(AddLiteralProperties_req __inbean,AddLiteralProperties_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,AddLiteralProperties_req __inbean,AddLiteralProperties_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,AddLiteralProperties_req __inbean,ServletContext context) {
