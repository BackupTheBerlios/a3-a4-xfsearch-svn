//d916d7dbccfbe322237b3b63b74c064

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetInstancesForObjectPropertyService.java
...
/**
 * Clase base para la operación GetInstancesForObjectProperty : Get all possible instances for a given object property
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetInstancesForObjectPropertyService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetInstancesForObjectProperty_req __inbean,GetInstancesForObjectProperty_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetInstancesForObjectProperty_req __inbean,GetInstancesForObjectProperty_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetInstancesForObjectProperty_req __inbean,ServletContext context) {
