//a0db34f2d4a2e09dcce4603877e415b

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetResourcesByType_req.java
 ...
 * @version 1.0
 */
public class GetResourcesByType_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetResourcesByType_req(GetResourcesByType_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetResourcesByType_req object) {
     ...
     * @param    typeUri    
     */
    public GetResourcesByType_req(String typeUri) {
        setTypeUri(typeUri);
    }
    ...
    public String toString() {
        return this.toXML("GetResourcesByType_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetResourcesByType_req)) {
            return false;
        }
        GetResourcesByType_req value = (GetResourcesByType_req)obj;
        if (!(value.typeUri.equals(this.typeUri))) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo typeUri
        code = tdi.gen.TdiHashcode.concat(code,this.typeUri);
        return code;
    }
     ...
     */
    public static boolean equals(GetResourcesByType_req[] __array1,GetResourcesByType_req[] __array2) {
    ...
    /**
     * Lectura del atributo typeUri
     * @return   Valor del atributo typeUri
     */
    public String getTypeUri() { return this.typeUri; }

    /**
     * Escritura del atributo typeUri
     * @param    valor    Nuevo valor del atributo typeUri
     */
    public void setTypeUri(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.typeUri = valor;
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.typeUri = input.extract_String();
    setChanged();
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetResourcesByType_req';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.retrieval.beans';\n");
    }
    js.append(varName+".typeUri = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.typeUri)+"';\n");
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetResourcesByType_req\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetResourcesByType_req type=\"GetResourcesByType_req\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<typeUri type=\"string\">"+tdi.text.StringUtil.escapeXML(this.typeUri,false)+"</typeUri>");
    } else {
        xml.append(_indentar(indents+1)+"<typeUri type=\"string\">"+this.typeUri+"</typeUri>");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetResourcesByType_req>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("typeUri", tdi.text.StringUtil.sustituyeUnicode(this.typeUri));
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_typeUri = __params__.get("typeUri");
    if (__object_typeUri == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo typeUri");
    }
    if (!(__object_typeUri instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo typeUri no es de tipo String");
    }
    setTypeUri((String)__object_typeUri);
    setChanged();
  }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"typeUri");
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        writer.write("<typeUri>");
        writer.write(tdi.text.StringUtil.escapeXML(this.getTypeUri(), false));
        writer.write("</typeUri>");
        writer.write("\n");
    }
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("typeUri");
        if (node != null && node.getContents() != null) {
            this.setTypeUri(node.getContents());
        }
    ...
    public void toJSON(JSONObject json) throws JSONException {
        JSONObject jObject;
        json.put("typeUri",this.getTypeUri());
        JSONArray jArray;
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setTypeUri(json.getString("typeUri"));
        JSONArray jArray;
        JSONArray jObjectArray;
    }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetResourcesByType_req(this);
    }
    /**
