//295d3c1161dbae17d9278edeb9a4d3

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : AddLiteralProperties_resp.java
 ...
 * @version 1.0
 */
public class AddLiteralProperties_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public AddLiteralProperties_resp() {
     ...
     */
    public AddLiteralProperties_resp(AddLiteralProperties_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(AddLiteralProperties_resp object) {
     ...
     * @param    resourceUri    
     */
    public AddLiteralProperties_resp(String resourceUri) {
    ...
    public String toString() {
        return this.toXML("AddLiteralProperties_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof AddLiteralProperties_resp)) {
            return false;
        }
        AddLiteralProperties_resp value = (AddLiteralProperties_resp)obj;
     ...
     */
    public static boolean equals(AddLiteralProperties_resp[] __array1,AddLiteralProperties_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'AddLiteralProperties_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"AddLiteralProperties_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<AddLiteralProperties_resp type=\"AddLiteralProperties_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</AddLiteralProperties_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new AddLiteralProperties_resp(this);
    }
    /**
