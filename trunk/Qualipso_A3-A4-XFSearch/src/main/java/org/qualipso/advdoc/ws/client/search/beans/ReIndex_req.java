//61fe7bf044e1b555b3f7c370b6c28c21

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ReIndex_req.java
 ...
 * @version 1.0
 */
public class ReIndex_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public ReIndex_req(ReIndex_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ReIndex_req object) {
        setChanged();
    }
    ...
    public String toString() {
        return this.toXML("ReIndex_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ReIndex_req)) {
            return false;
        }
        ReIndex_req value = (ReIndex_req)obj;
        return true;
    }
     ...
     */
    public static boolean equals(ReIndex_req[] __array1,ReIndex_req[] __array2) {
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ReIndex_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ReIndex_req type=\"ReIndex_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
