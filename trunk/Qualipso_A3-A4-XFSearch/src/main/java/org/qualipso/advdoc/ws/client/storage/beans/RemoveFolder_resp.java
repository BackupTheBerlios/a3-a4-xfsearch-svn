//877ef06a24eecba9dbcd502ae3269e90

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : RemoveFolder_resp.java
 ...
 * @version 1.0
 */
public class RemoveFolder_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public RemoveFolder_resp(RemoveFolder_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(RemoveFolder_resp object) {
     ...
     * @param    result    
     */
    public RemoveFolder_resp(int result) {
        setResult(result);
    }
    ...
    public String toString() {
        return this.toXML("RemoveFolder_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RemoveFolder_resp)) {
            return false;
        }
        RemoveFolder_resp value = (RemoveFolder_resp)obj;
     ...
     */
    public static boolean equals(RemoveFolder_resp[] __array1,RemoveFolder_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'RemoveFolder_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"RemoveFolder_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<RemoveFolder_resp type=\"RemoveFolder_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</RemoveFolder_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new RemoveFolder_resp(this);
    }
    /**
