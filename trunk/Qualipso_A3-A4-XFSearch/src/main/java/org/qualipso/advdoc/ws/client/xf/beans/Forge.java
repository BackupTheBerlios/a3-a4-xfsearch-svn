//4fcf42dff7a765b1a24a0d989b6ccd4
 ...
 * @version 1.0
 */
public class Forge extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     * @param    object    Objeto a copiar
     */
    public void set(Forge object) {
        setForgeName(object.getForgeName());
        setChanged();
    }
     ...
     * @param    forgeName    
     */
    public Forge(String forgeName) {
        setForgeName(forgeName);
    }
    ...
    public boolean equals(Object obj) {
        ...
        Forge value = (Forge)obj;
        if (!(value.forgeName.equals(this.forgeName))) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo forgeName
        code = tdi.gen.TdiHashcode.concat(code,this.forgeName);
        return code;
    }
     ...
     */
    public static boolean equals(Forge[] __array1,Forge[] __array2) {
    ...
    /**
     * Lectura del atributo forgeName
     * @return   Valor del atributo forgeName
     */
    public String getForgeName() { return this.forgeName; }

    /**
     * Escritura del atributo forgeName
     * @param    valor    Nuevo valor del atributo forgeName
     */
    public void setForgeName(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.forgeName = valor;
        setChanged();
    }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.forgeName = input.extract_String();
    setChanged();
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'Forge';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.xf.beans';\n");
    }
    js.append(varName+".forgeName = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.forgeName)+"';\n");
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"Forge\" package=\"org.qualipso.advdoc.ws.client.xf.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<Forge type=\"Forge\" package=\"org.qualipso.advdoc.ws.client.xf.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<forgeName type=\"string\">"+tdi.text.StringUtil.escapeXML(this.forgeName,false)+"</forgeName>");
    } else {
        xml.append(_indentar(indents+1)+"<forgeName type=\"string\">"+this.forgeName+"</forgeName>");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</Forge>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("forgeName", tdi.text.StringUtil.sustituyeUnicode(this.forgeName));
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_forgeName = __params__.get("forgeName");
    if (__object_forgeName == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo forgeName");
    }
    if (!(__object_forgeName instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo forgeName no es de tipo String");
    }
    setForgeName((String)__object_forgeName);
    setChanged();
  }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"forgeName");
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        writer.write("<forgeName>");
        writer.write(tdi.text.StringUtil.escapeXML(this.getForgeName(), false));
        writer.write("</forgeName>");
        writer.write("\n");
    }
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("forgeName");
        if (node != null && node.getContents() != null) {
            this.setForgeName(node.getContents());
        }
    ...
    public void toJSON(JSONObject json) throws JSONException {
        JSONObject jObject;
        json.put("forgeName",this.getForgeName());
        JSONArray jArray;
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setForgeName(json.getString("forgeName"));
        JSONArray jArray;
        JSONArray jObjectArray;
    }
