//211d26a162144bf58bcdf43f93eaf94

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : CreateProperty_req.java
 ...
 * @version 1.0
 */
public class CreateProperty_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public CreateProperty_req(CreateProperty_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(CreateProperty_req object) {
     ...
     * @param    propertyUri    
     */
    public CreateProperty_req(String propertyUri) {
    ...
    public String toString() {
        return this.toXML("CreateProperty_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CreateProperty_req)) {
            return false;
        }
        CreateProperty_req value = (CreateProperty_req)obj;
     ...
     */
    public static boolean equals(CreateProperty_req[] __array1,CreateProperty_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'CreateProperty_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"CreateProperty_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<CreateProperty_req type=\"CreateProperty_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</CreateProperty_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new CreateProperty_req(this);
    }
    /**
