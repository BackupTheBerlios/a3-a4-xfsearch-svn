//1a21a6b4d5afee601c5bcfa529d3e

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetDisjointClassesService.java
...
/**
 * Clase base para la operación GetDisjointClasses : Get disjoint classes to a given one
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetDisjointClassesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetDisjointClasses_req __inbean,GetDisjointClasses_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetDisjointClasses_req __inbean,GetDisjointClasses_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetDisjointClasses_req __inbean,ServletContext context) {
