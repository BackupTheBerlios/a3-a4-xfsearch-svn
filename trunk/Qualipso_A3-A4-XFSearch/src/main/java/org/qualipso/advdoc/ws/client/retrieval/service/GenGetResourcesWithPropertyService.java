//f91726eee74bd43870b7e1e253ad917b

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetResourcesWithPropertyService.java
...
/**
 * Clase base para la operación GetResourcesWithProperty : Get all resources with a given property
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetResourcesWithPropertyService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetResourcesWithProperty_req __inbean,GetResourcesWithProperty_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetResourcesWithProperty_req __inbean,GetResourcesWithProperty_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetResourcesWithProperty_req __inbean,ServletContext context) {
