//6ea522bb8eea5d666eff77c4dabab7

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetResourceProperties_req.java
 ...
 * @version 1.0
 */
public class GetResourceProperties_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetResourceProperties_req() {
     ...
     */
    public GetResourceProperties_req(GetResourceProperties_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetResourceProperties_req object) {
     ...
     * @param    resourceUri    
     */
    public GetResourceProperties_req(String resourceUri) {
    ...
    public String toString() {
        return this.toXML("GetResourceProperties_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetResourceProperties_req)) {
            return false;
        }
        GetResourceProperties_req value = (GetResourceProperties_req)obj;
     ...
     */
    public static boolean equals(GetResourceProperties_req[] __array1,GetResourceProperties_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetResourceProperties_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetResourceProperties_req\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetResourceProperties_req type=\"GetResourceProperties_req\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetResourceProperties_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetResourceProperties_req(this);
    }
    /**
