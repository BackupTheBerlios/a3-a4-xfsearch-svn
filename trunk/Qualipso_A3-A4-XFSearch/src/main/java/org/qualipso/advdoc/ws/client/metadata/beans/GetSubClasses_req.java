//e67a55734f2320df363bb7c92e49b1a

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetSubClasses_req.java
 ...
 * @version 1.0
 */
public class GetSubClasses_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetSubClasses_req(GetSubClasses_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetSubClasses_req object) {
     ...
     * @param    direct    
     */
    public GetSubClasses_req(String classUri,int direct) {
    ...
    public String toString() {
        return this.toXML("GetSubClasses_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetSubClasses_req)) {
            return false;
        }
        GetSubClasses_req value = (GetSubClasses_req)obj;
     ...
     */
    public static boolean equals(GetSubClasses_req[] __array1,GetSubClasses_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetSubClasses_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetSubClasses_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetSubClasses_req type=\"GetSubClasses_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetSubClasses_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetSubClasses_req(this);
    }
    /**
