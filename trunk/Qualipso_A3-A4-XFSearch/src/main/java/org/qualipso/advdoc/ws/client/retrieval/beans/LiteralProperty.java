//d4a2e3ebdffa5385a6242aea8cecd9

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : LiteralProperty.java
 ...
 * @version 1.0
 */
public class LiteralProperty extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public LiteralProperty(LiteralProperty object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(LiteralProperty object) {
        setLiteral(object.getLiteral());
     ...
     * @param    propertyUri    
     */
    public LiteralProperty(String propertyUri,String literal) {
        setLiteral(literal);
    ...
    public String toString() {
        return this.toXML("LiteralProperty",0);
    }
    ...
    public boolean equals(Object obj) {
        ...
        LiteralProperty value = (LiteralProperty)obj;
        if (!(value.literal.equals(this.literal))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo literal
        code = tdi.gen.TdiHashcode.concat(code,this.literal);
     ...
     */
    public static boolean equals(LiteralProperty[] __array1,LiteralProperty[] __array2) {
    ...
    /**
     * Lectura del atributo literal
     * @return   Valor del atributo literal
     */
    public String getLiteral() { return this.literal; }

    /**
     * Escritura del atributo literal
     * @param    valor    Nuevo valor del atributo literal
     */
    public void setLiteral(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.literal = valor;
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.literal = input.extract_String();
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'LiteralProperty';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.retrieval.beans';\n");
    }
    js.append(varName+".literal = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.literal)+"';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"LiteralProperty\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<LiteralProperty type=\"LiteralProperty\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<literal type=\"string\">"+tdi.text.StringUtil.escapeXML(this.literal,false)+"</literal>");
    } else {
        xml.append(_indentar(indents+1)+"<literal type=\"string\">"+this.literal+"</literal>");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</LiteralProperty>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("literal", tdi.text.StringUtil.sustituyeUnicode(this.literal));
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_literal = __params__.get("literal");
    if (__object_literal == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo literal");
    }
    if (!(__object_literal instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo literal no es de tipo String");
    }
    setLiteral((String)__object_literal);
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"literal");
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        ...
        writer.write(tdi.text.StringUtil.escapeXML(this.getLiteral(), false));
        writer.write("</literal>");
        writer.write("\n");
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("literal");
        if (node != null && node.getContents() != null) {
            this.setLiteral(node.getContents());
        }
    ...
    public void toJSON(JSONObject json) throws JSONException {
        JSONObject jObject;
        json.put("literal",this.getLiteral());
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setLiteral(json.getString("literal"));
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new LiteralProperty(this);
    }
    /**
