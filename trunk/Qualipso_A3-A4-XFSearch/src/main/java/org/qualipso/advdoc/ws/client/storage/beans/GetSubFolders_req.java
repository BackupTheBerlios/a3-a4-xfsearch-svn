//64e1766e91ee2915aedab25ff432a72

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetSubFolders_req.java
 ...
 * @version 1.0
 */
public class GetSubFolders_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetSubFolders_req(GetSubFolders_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetSubFolders_req object) {
     ...
     * @param    path    
     */
    public GetSubFolders_req(org.qualipso.advdoc.ws.client.storage.beans.FolderPath path) {
        setPath(path);
    }
    ...
    public String toString() {
        return this.toXML("GetSubFolders_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetSubFolders_req)) {
            return false;
        }
        GetSubFolders_req value = (GetSubFolders_req)obj;
     ...
     */
    public static boolean equals(GetSubFolders_req[] __array1,GetSubFolders_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetSubFolders_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetSubFolders_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetSubFolders_req type=\"GetSubFolders_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetSubFolders_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetSubFolders_req(this);
    }
    /**
