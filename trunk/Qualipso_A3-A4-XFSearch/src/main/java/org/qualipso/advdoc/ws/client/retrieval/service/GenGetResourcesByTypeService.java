//ecc683115e874384e9676819832fa376

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetResourcesByTypeService.java
...
/**
 * Clase base para la operación GetResourcesByType : Get all resources of a given type or class
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetResourcesByTypeService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetResourcesByType_req __inbean,GetResourcesByType_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetResourcesByType_req __inbean,GetResourcesByType_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetResourcesByType_req __inbean,ServletContext context) {
