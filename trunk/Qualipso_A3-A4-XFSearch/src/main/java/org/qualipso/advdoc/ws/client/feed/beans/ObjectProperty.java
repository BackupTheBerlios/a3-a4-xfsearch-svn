//33ffc5d2fa286447b8ff5fe5f0fa63

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ObjectProperty.java
 ...
 * @version 1.0
 */
public class ObjectProperty extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public ObjectProperty(ObjectProperty object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ObjectProperty object) {
     ...
     * @param    propertyUri    
     */
    public ObjectProperty(String propertyUri,String objectUri) {
    ...
    public String toString() {
        return this.toXML("ObjectProperty",0);
    }
    ...
    public boolean equals(Object obj) {
        ...
        ObjectProperty value = (ObjectProperty)obj;
     ...
     */
    public static boolean equals(ObjectProperty[] __array1,ObjectProperty[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ObjectProperty';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ObjectProperty\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ObjectProperty type=\"ObjectProperty\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ObjectProperty>");
    }
    return xml.toString();
  }
