//c5b88d693fdb5f7213fc83fef21d6dc

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetRangeAndPropertiesService.java
...
/**
 * Clase base para la operación GetRangeAndProperties : Get the range of a given property. It also gets the properties of each range class
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetRangeAndPropertiesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetRangeAndProperties_req __inbean,GetRangeAndProperties_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetRangeAndProperties_req __inbean,GetRangeAndProperties_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetRangeAndProperties_req __inbean,ServletContext context) {
