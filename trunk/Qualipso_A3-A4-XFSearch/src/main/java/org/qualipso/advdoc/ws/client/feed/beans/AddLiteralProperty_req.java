//7388eb8b732466dab57e1e2b91b84469

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : AddLiteralProperty_req.java
 ...
 * @version 1.0
 */
public class AddLiteralProperty_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public AddLiteralProperty_req(AddLiteralProperty_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(AddLiteralProperty_req object) {
     ...
     * @param    value    
     */
    public AddLiteralProperty_req(String resourceUri,String propertyUri,String value) {
    ...
    public String toString() {
        return this.toXML("AddLiteralProperty_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof AddLiteralProperty_req)) {
            return false;
        }
        AddLiteralProperty_req value = (AddLiteralProperty_req)obj;
     ...
     */
    public static boolean equals(AddLiteralProperty_req[] __array1,AddLiteralProperty_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'AddLiteralProperty_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"AddLiteralProperty_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<AddLiteralProperty_req type=\"AddLiteralProperty_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</AddLiteralProperty_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new AddLiteralProperty_req(this);
    }
    /**
