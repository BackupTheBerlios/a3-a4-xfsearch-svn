//465b354295697e40e5627f74d3d5455

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : AddObjectProperty_resp.java
 ...
 * @version 1.0
 */
public class AddObjectProperty_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public AddObjectProperty_resp(AddObjectProperty_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(AddObjectProperty_resp object) {
     ...
     * @param    resourceUri    
     */
    public AddObjectProperty_resp(String resourceUri) {
    ...
    public String toString() {
        return this.toXML("AddObjectProperty_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof AddObjectProperty_resp)) {
            return false;
        }
        AddObjectProperty_resp value = (AddObjectProperty_resp)obj;
     ...
     */
    public static boolean equals(AddObjectProperty_resp[] __array1,AddObjectProperty_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'AddObjectProperty_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"AddObjectProperty_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<AddObjectProperty_resp type=\"AddObjectProperty_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</AddObjectProperty_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new AddObjectProperty_resp(this);
    }
    /**
