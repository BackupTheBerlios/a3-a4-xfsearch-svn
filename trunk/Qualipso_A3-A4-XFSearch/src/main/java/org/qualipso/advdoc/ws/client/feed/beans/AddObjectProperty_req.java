//8ee0a84d76568ee13527f756fa89f8

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : AddObjectProperty_req.java
 ...
 * @version 1.0
 */
public class AddObjectProperty_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public AddObjectProperty_req(AddObjectProperty_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(AddObjectProperty_req object) {
        setObjectUri(object.getObjectUri());
     ...
     * @param    resourceUri    
     */
    public AddObjectProperty_req(String resourceUri,String propertyUri,String objectUri) {
    ...
    public String toString() {
        return this.toXML("AddObjectProperty_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof AddObjectProperty_req)) {
            return false;
        }
        AddObjectProperty_req value = (AddObjectProperty_req)obj;
        if (!(value.objectUri.equals(this.objectUri))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo objectUri
        code = tdi.gen.TdiHashcode.concat(code,this.objectUri);
     ...
     */
    public static boolean equals(AddObjectProperty_req[] __array1,AddObjectProperty_req[] __array2) {
    ...
    /**
     * Lectura del atributo objectUri
     * @return   Valor del atributo objectUri
     */
    public String getObjectUri() { return this.objectUri; }

    /**
     * Escritura del atributo objectUri
     * @param    valor    Nuevo valor del atributo objectUri
     */
    public void setObjectUri(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.objectUri = valor;
        setChanged();
    }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.objectUri = input.extract_String();
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'AddObjectProperty_req';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.feed.beans';\n");
    }
    js.append(varName+".objectUri = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.objectUri)+"';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"AddObjectProperty_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<AddObjectProperty_req type=\"AddObjectProperty_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<objectUri type=\"string\">"+tdi.text.StringUtil.escapeXML(this.objectUri,false)+"</objectUri>");
    } else {
        xml.append(_indentar(indents+1)+"<objectUri type=\"string\">"+this.objectUri+"</objectUri>");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</AddObjectProperty_req>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("objectUri", tdi.text.StringUtil.sustituyeUnicode(this.objectUri));
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_objectUri = __params__.get("objectUri");
    if (__object_objectUri == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo objectUri");
    }
    if (!(__object_objectUri instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo objectUri no es de tipo String");
    }
    setObjectUri((String)__object_objectUri);
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"objectUri");
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        writer.write("<objectUri>");
        writer.write(tdi.text.StringUtil.escapeXML(this.getObjectUri(), false));
        writer.write("</objectUri>");
        writer.write("\n");
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("objectUri");
        if (node != null && node.getContents() != null) {
            this.setObjectUri(node.getContents());
        }
    ...
    public void toJSON(JSONObject json) throws JSONException {
        JSONObject jObject;
        json.put("objectUri",this.getObjectUri());
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setObjectUri(json.getString("objectUri"));
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new AddObjectProperty_req(this);
    }
    /**
