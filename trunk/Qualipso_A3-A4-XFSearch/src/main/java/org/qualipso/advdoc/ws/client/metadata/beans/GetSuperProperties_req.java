//ef39d35b375c7bcc422043c7fac173d

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetSuperProperties_req.java
 ...
 * @version 1.0
 */
public class GetSuperProperties_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetSuperProperties_req(GetSuperProperties_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetSuperProperties_req object) {
     ...
     * @param    propertyUri    
     */
    public GetSuperProperties_req(String propertyUri,int direct) {
        setDirect(direct);
    ...
    public String toString() {
        return this.toXML("GetSuperProperties_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetSuperProperties_req)) {
            return false;
        }
        GetSuperProperties_req value = (GetSuperProperties_req)obj;
     ...
     */
    public static boolean equals(GetSuperProperties_req[] __array1,GetSuperProperties_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetSuperProperties_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetSuperProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetSuperProperties_req type=\"GetSuperProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetSuperProperties_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetSuperProperties_req(this);
    }
    /**
