//8f74d458fd457443c6d9def122d4024

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : BuildSPARQLQuery_resp.java
 ...
 * @version 1.0
 */
public class BuildSPARQLQuery_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public BuildSPARQLQuery_resp(BuildSPARQLQuery_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(BuildSPARQLQuery_resp object) {
     ...
     * @param    sparql    
     */
    public BuildSPARQLQuery_resp(String sparql) {
        setSparql(sparql);
    }
    ...
    public String toString() {
        return this.toXML("BuildSPARQLQuery_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof BuildSPARQLQuery_resp)) {
            return false;
        }
        BuildSPARQLQuery_resp value = (BuildSPARQLQuery_resp)obj;
     ...
     */
    public static boolean equals(BuildSPARQLQuery_resp[] __array1,BuildSPARQLQuery_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'BuildSPARQLQuery_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"BuildSPARQLQuery_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<BuildSPARQLQuery_resp type=\"BuildSPARQLQuery_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</BuildSPARQLQuery_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new BuildSPARQLQuery_resp(this);
    }
    /**
