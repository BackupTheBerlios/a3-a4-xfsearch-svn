//ab3acb3d43a025cfddcd508b42c93358

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenExecSPARQLService.java
...
/**
 * Clase base para la operación ExecSPARQL : Execute any SPARQL query on model
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenExecSPARQLService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(ExecSPARQL_req __inbean,ExecSPARQL_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,ExecSPARQL_req __inbean,ExecSPARQL_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,ExecSPARQL_req __inbean,ServletContext context) {
