//d9be1591e72ae539ada185bfd840f920

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : StoreBinaryFile_resp.java
 ...
 * @version 1.0
 */
public class StoreBinaryFile_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public StoreBinaryFile_resp(StoreBinaryFile_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(StoreBinaryFile_resp object) {
     ...
     * @param    result    
     */
    public StoreBinaryFile_resp(int result) {
        setResult(result);
    }
    ...
    public String toString() {
        return this.toXML("StoreBinaryFile_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof StoreBinaryFile_resp)) {
            return false;
        }
        StoreBinaryFile_resp value = (StoreBinaryFile_resp)obj;
        if (value.result != this.result) {
            return false;
        }
        return true;
    }
     ...
     */
    public static boolean equals(StoreBinaryFile_resp[] __array1,StoreBinaryFile_resp[] __array2) {
     ...
     */
    public void setResult(int valor) { 
        this.result = valor;
        setChanged();
    }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'StoreBinaryFile_resp';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.storage.beans';\n");
    }
    js.append(varName+".result = "+this.result+";\n");
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"StoreBinaryFile_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<StoreBinaryFile_resp type=\"StoreBinaryFile_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    xml.append(_indentar(indents+1)+"<result type=\"int\">"+this.result+"</result>");
    xml.append("\n");
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"</"+tag+">");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents)+"</StoreBinaryFile_resp>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("result", new Integer(result));
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    ...
    if (!(__object_result instanceof Integer)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo result no es de tipo Integer");
    }
    Integer __int_result = (Integer)__object_result;
    setResult(__int_result.intValue());
    setChanged();
  }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      ...
      setResult(Integer.parseInt(__v));
    }
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        writer.write("<result>");
        writer.write(Integer.toString(this.getResult()));
        writer.write("</result>");
        writer.write("\n");
    }
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        if (node != null && node.getContents() != null) {
            this.setResult(Integer.parseInt(node.getContents()));
        }
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setResult(json.getInt("result"));
        JSONArray jArray;
        JSONArray jObjectArray;
    }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new StoreBinaryFile_resp(this);
    }
    /**
