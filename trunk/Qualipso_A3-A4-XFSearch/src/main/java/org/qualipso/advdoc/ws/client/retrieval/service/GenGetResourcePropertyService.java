//ae2e84c617e3668f572ba4877194c38

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetResourcePropertyService.java
...
/**
 * Clase base para la operación GetResourceProperty : Get a property of a given resource
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetResourcePropertyService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetResourceProperty_req __inbean,GetResourceProperty_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetResourceProperty_req __inbean,GetResourceProperty_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetResourceProperty_req __inbean,ServletContext context) {
