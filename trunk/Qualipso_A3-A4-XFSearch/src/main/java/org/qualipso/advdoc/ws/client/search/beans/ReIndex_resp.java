//d75eff91f1511b43393f47d7cd7d379

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ReIndex_resp.java
 ...
 * @version 1.0
 */
public class ReIndex_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public ReIndex_resp(ReIndex_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ReIndex_resp object) {
     ...
     * @param    time    
     */
    public ReIndex_resp(double time) {
        setTime(time);
    }
    ...
    public String toString() {
        return this.toXML("ReIndex_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ReIndex_resp)) {
            return false;
        }
        ReIndex_resp value = (ReIndex_resp)obj;
     ...
     */
    public static boolean equals(ReIndex_resp[] __array1,ReIndex_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ReIndex_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ReIndex_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ReIndex_resp type=\"ReIndex_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ReIndex_resp>");
    }
    return xml.toString();
  }
