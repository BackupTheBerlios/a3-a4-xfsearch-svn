//53874956bb8f229e6caeac4394f2e44

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenStoreFileService.java
...
/**
 * Clase base para la operación StoreFile : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenStoreFileService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(StoreFile_req __inbean,StoreFile_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,StoreFile_req __inbean,StoreFile_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,StoreFile_req __inbean,ServletContext context) {
