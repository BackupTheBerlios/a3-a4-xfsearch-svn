//da95534bce7f2e6301468f9cad5ad

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : Save_resp.java
 ...
 * @version 1.0
 */
public class Save_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public Save_resp(Save_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(Save_resp object) {
        setFilename(object.getFilename());
        setFilesize(object.getFilesize());
        setChanged();
    }
     ...
     * @param    filesize    
     */
    public Save_resp(String filename,int filesize) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof Save_resp)) {
            return false;
        }
        Save_resp value = (Save_resp)obj;
        if (!(value.filename.equals(this.filename))) {
            return false;
        }
        if (value.filesize != this.filesize) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        // Concatenar con el hashcode del atributo filesize
        code = tdi.gen.TdiHashcode.concat(code,this.filesize);
        return code;
    }
     ...
     */
    public static boolean equals(Save_resp[] __array1,Save_resp[] __array2) {
    ...
    /**
     * Lectura del atributo filesize
     * @return   Valor del atributo filesize
     */
    public int getFilesize() { return this.filesize; }

    /**
     * Escritura del atributo filesize
     * @param    valor    Nuevo valor del atributo filesize
     */
    public void setFilesize(int valor) { 
        this.filesize = valor;
        setChanged();
    }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    ...
    this.filesize = input.extract_int();
    setChanged();
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'Save_resp';\n");
    ...
    js.append(varName+".filesize = "+this.filesize+";\n");
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"Save_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<Save_resp type=\"Save_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    xml.append("\n");
    xml.append(_indentar(indents+1)+"<filesize type=\"int\">"+this.filesize+"</filesize>");
    xml.append("\n");
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"</"+tag+">");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents)+"</Save_resp>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    ...
    __struct__.put("filesize", new Integer(filesize));
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    ...
    Object __object_filesize = __params__.get("filesize");
    if (__object_filesize == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo filesize");
    }
    if (!(__object_filesize instanceof Integer)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo filesize no es de tipo Integer");
    }
    Integer __int_filesize = (Integer)__object_filesize;
    setFilesize(__int_filesize.intValue());
    setChanged();
  }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    ...
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"filesize");
      if (__e != null && __e.getChildNodes().item(0) != null) {
        __v = __e.getChildNodes().item(0).getNodeValue();
      }
      setFilesize(Integer.parseInt(__v));
    }
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        ...
        writer.write(Integer.toString(this.getFilesize()));
        writer.write("</filesize>");
        writer.write("\n");
    }
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("filesize");
        if (node != null && node.getContents() != null) {
            this.setFilesize(Integer.parseInt(node.getContents()));
        }
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        ...
        this.setFilesize(json.getInt("filesize"));
        JSONArray jArray;
        JSONArray jObjectArray;
    }
