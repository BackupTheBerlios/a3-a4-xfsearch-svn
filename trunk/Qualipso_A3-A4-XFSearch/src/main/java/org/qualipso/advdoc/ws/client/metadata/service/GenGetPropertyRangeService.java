//1b902bbc791c8ad72fd9885f6e3d0

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetPropertyRangeService.java
...
/**
 * Clase base para la operación GetPropertyRange : Get the range of a given property
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetPropertyRangeService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetPropertyRange_req __inbean,GetPropertyRange_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetPropertyRange_req __inbean,GetPropertyRange_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetPropertyRange_req __inbean,ServletContext context) {
