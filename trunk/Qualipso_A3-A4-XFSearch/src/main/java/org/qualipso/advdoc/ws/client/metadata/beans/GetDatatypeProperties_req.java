//894a64c7a2e13bbf823597f9ed24169

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetDatatypeProperties_req.java
 ...
 * @version 1.0
 */
public class GetDatatypeProperties_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetDatatypeProperties_req() {
     ...
     */
    public GetDatatypeProperties_req(GetDatatypeProperties_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetDatatypeProperties_req object) {
     ...
     * @param    classUri    
     */
    public GetDatatypeProperties_req(String classUri) {
    ...
    public String toString() {
        return this.toXML("GetDatatypeProperties_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetDatatypeProperties_req)) {
            return false;
        }
        GetDatatypeProperties_req value = (GetDatatypeProperties_req)obj;
     ...
     */
    public static boolean equals(GetDatatypeProperties_req[] __array1,GetDatatypeProperties_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetDatatypeProperties_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetDatatypeProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetDatatypeProperties_req type=\"GetDatatypeProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetDatatypeProperties_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetDatatypeProperties_req(this);
    }
    /**
