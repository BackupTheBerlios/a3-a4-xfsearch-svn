//7dafed3583a313646dc3351ee48bc7b

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ExecConstructAndSearch_resp.java
 ...
 * @version 1.0
 */
public class ExecConstructAndSearch_resp extends org.qualipso.advdoc.ws.client.search.beans.ExecQuery_resp implements es.tid.serial.TdiBean {
     ...
     */
    public ExecConstructAndSearch_resp() {
     ...
     */
    public ExecConstructAndSearch_resp(ExecConstructAndSearch_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ExecConstructAndSearch_resp object) {
        super.set(object);
        setChanged();
    }
     ...
     * @param    result    (heredado de ExecQuery_resp)
     * @param    sparql    SPARQL query(heredado de ExecQuery_resp)
     * @param    time    Query time in seconds(heredado de ExecQuery_resp)
     */
    public ExecConstructAndSearch_resp(org.qualipso.advdoc.ws.client.search.beans.SPARQLResult result,String sparql,double time) {
        super(result,sparql,time);
    }
    ...
    public String toString() {
        return this.toXML("ExecConstructAndSearch_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ExecConstructAndSearch_resp)) {
            return false;
        }
        ExecConstructAndSearch_resp value = (ExecConstructAndSearch_resp)obj;
        if (!super.equals(obj)) {
            return false;
        }
        return true;
     ...
     */
    public static boolean equals(ExecConstructAndSearch_resp[] __array1,ExecConstructAndSearch_resp[] __array2) {
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "ExecConstructAndSearch_resp  extends ExecQuery_resp<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string sparql (*)<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;double time (*)<BR>",
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ExecConstructAndSearch_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ExecConstructAndSearch_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ExecConstructAndSearch_resp type=\"ExecConstructAndSearch_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ExecConstructAndSearch_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new ExecConstructAndSearch_resp(this);
    }
    /**
    ...
    public void copyFrom(Object source) throws ClassCastException {
        if (!(source instanceof ExecConstructAndSearch_resp)) {
            throw new ClassCastException(getClass().getName()+".copyFrom() El objeto de copia es de la clase "+source.getClass().getName());
        }
        ExecConstructAndSearch_resp bean = (ExecConstructAndSearch_resp)source;
        this.set(bean);
    }
