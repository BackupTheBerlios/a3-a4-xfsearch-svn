...
public class SPARQLResult extends java.util.Observable implements es.tid.serial.TdiBean {
    ...
    /**
     * Eliminar el elemento i-ésimo del atributo columns
...
public     boolean removeColumns(int position) {
    ...
    /**
     * Número de elementos en el atributo columns
    ...
    /**
     * Eliminar el elemento i-ésimo del atributo rows
     * @param    position    Posición del elemento que se quiere eliminar
     * @return   false si no se puede eliminar
     */
public     boolean removeRows(int position) {
    ...
    /**
     * Número de elementos en el atributo rows
     * @return   Número de elementos
     */
