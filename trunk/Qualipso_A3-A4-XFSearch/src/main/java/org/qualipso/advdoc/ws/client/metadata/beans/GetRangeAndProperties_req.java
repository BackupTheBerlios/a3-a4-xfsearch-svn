//b57acc2ac18b4523cd32cf6252d869a

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetRangeAndProperties_req.java
 ...
 * @version 1.0
 */
public class GetRangeAndProperties_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetRangeAndProperties_req() {
     ...
     */
    public GetRangeAndProperties_req(GetRangeAndProperties_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetRangeAndProperties_req object) {
     ...
     * @param    propertyUri    
     */
    public GetRangeAndProperties_req(String propertyUri) {
    ...
    public String toString() {
        return this.toXML("GetRangeAndProperties_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetRangeAndProperties_req)) {
            return false;
        }
        GetRangeAndProperties_req value = (GetRangeAndProperties_req)obj;
     ...
     */
    public static boolean equals(GetRangeAndProperties_req[] __array1,GetRangeAndProperties_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetRangeAndProperties_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetRangeAndProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetRangeAndProperties_req type=\"GetRangeAndProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetRangeAndProperties_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetRangeAndProperties_req(this);
    }
    /**
