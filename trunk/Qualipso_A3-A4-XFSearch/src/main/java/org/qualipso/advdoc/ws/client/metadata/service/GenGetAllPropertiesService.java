//6af992c11f78fda0bcbbf627cacc045

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetAllPropertiesService.java
...
/**
 * Clase base para la operación GetAllProperties : Get datatype and object properties of a given class
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetAllPropertiesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetAllProperties_req __inbean,GetAllProperties_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetAllProperties_req __inbean,GetAllProperties_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetAllProperties_req __inbean,ServletContext context) {
