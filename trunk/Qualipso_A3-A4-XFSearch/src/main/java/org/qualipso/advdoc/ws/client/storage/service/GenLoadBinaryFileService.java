//ed73c87621fadaa2aec748afca1a7086

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenLoadBinaryFileService.java
...
/**
 * Clase base para la operación LoadBinaryFile : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenLoadBinaryFileService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(LoadBinaryFile_req __inbean,LoadBinaryFile_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,LoadBinaryFile_req __inbean,LoadBinaryFile_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,LoadBinaryFile_req __inbean,ServletContext context) {
