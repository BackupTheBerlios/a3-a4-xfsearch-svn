//ca5debbe15fae57dec38cae61d81533c

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetSearchSizeService.java
...
/**
 * Clase base para la operación GetSearchSize : Get the number of result of a search
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetSearchSizeService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetSearchSize_req __inbean,GetSearchSize_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetSearchSize_req __inbean,GetSearchSize_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetSearchSize_req __inbean,ServletContext context) {
