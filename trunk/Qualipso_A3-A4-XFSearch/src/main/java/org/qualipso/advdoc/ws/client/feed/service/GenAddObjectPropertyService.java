//db11771196933c674192d1387692f86

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenAddObjectPropertyService.java
...
/**
 * Clase base para la operación AddObjectProperty : Add an object property to an existing resource
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenAddObjectPropertyService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(AddObjectProperty_req __inbean,AddObjectProperty_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,AddObjectProperty_req __inbean,AddObjectProperty_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,AddObjectProperty_req __inbean,ServletContext context) {
