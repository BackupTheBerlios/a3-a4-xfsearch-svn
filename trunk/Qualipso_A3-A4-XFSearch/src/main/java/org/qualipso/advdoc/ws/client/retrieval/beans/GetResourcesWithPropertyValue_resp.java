//3bef3968e7ab0512a281f5b8a9b78

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetResourcesWithPropertyValue_resp.java
 ...
 * @version 1.0
 */
public class GetResourcesWithPropertyValue_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetResourcesWithPropertyValue_resp() {
     ...
     */
    public GetResourcesWithPropertyValue_resp(GetResourcesWithPropertyValue_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetResourcesWithPropertyValue_resp object) {
     ...
     * @param    resourcesUri    
     */
    public GetResourcesWithPropertyValue_resp(String[] resourcesUri) {
    ...
    public String toString() {
        return this.toXML("GetResourcesWithPropertyValue_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetResourcesWithPropertyValue_resp)) {
            return false;
        }
        GetResourcesWithPropertyValue_resp value = (GetResourcesWithPropertyValue_resp)obj;
     ...
     */
    public static boolean equals(GetResourcesWithPropertyValue_resp[] __array1,GetResourcesWithPropertyValue_resp[] __array2) {
    ...
    /**
     * Eliminar el elemento i-ésimo del atributo resourcesUri
...
public     boolean removeResourcesUri(int position) {
    ...
    /**
     * Número de elementos en el atributo resourcesUri
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "GetResourcesWithPropertyValue_resp <BR>",
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetResourcesWithPropertyValue_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetResourcesWithPropertyValue_resp\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetResourcesWithPropertyValue_resp type=\"GetResourcesWithPropertyValue_resp\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetResourcesWithPropertyValue_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetResourcesWithPropertyValue_resp(this);
    }
    /**
    ...
    public void copyFrom(Object source) throws ClassCastException {
        if (!(source instanceof GetResourcesWithPropertyValue_resp)) {
            throw new ClassCastException(getClass().getName()+".copyFrom() El objeto de copia es de la clase "+source.getClass().getName());
        }
        GetResourcesWithPropertyValue_resp bean = (GetResourcesWithPropertyValue_resp)source;
        this.set(bean);
    }
