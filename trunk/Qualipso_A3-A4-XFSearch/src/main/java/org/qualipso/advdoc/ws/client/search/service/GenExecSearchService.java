//56d69cd0adf586e6deaa48dff5155568

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenExecSearchService.java
...
/**
 * Clase base para la operación ExecSearch : xecute a query on RDF model (it can include text search). It builds the SPARQL sentence from parameters
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenExecSearchService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(ExecSearch_req __inbean,ExecSearch_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,ExecSearch_req __inbean,ExecSearch_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,ExecSearch_req __inbean,ServletContext context) {
