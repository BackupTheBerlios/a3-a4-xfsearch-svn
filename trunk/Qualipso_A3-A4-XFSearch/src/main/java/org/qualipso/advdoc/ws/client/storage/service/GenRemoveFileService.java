//e76378bae019467aeecbd28f6881157c

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenRemoveFileService.java
...
/**
 * Clase base para la operación RemoveFile : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenRemoveFileService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(RemoveFile_req __inbean,RemoveFile_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,RemoveFile_req __inbean,RemoveFile_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,RemoveFile_req __inbean,ServletContext context) {
