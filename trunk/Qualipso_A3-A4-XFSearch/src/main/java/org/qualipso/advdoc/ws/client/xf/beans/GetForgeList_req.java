//b88b2e91804633af2ee5e41273346814

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetForgeList_req.java
 ...
 * @version 1.0
 */
public class GetForgeList_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetForgeList_req(GetForgeList_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetForgeList_req object) {
        setChanged();
    }
    ...
    public String toString() {
        return this.toXML("GetForgeList_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetForgeList_req)) {
            return false;
        }
        GetForgeList_req value = (GetForgeList_req)obj;
        return true;
    }
     ...
     */
    public static boolean equals(GetForgeList_req[] __array1,GetForgeList_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetForgeList_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetForgeList_req\" package=\"org.qualipso.advdoc.ws.client.xf.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetForgeList_req type=\"GetForgeList_req\" package=\"org.qualipso.advdoc.ws.client.xf.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetForgeList_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetForgeList_req(this);
    }
    /**
