//18a1a325a7ddea5b3c4a554eb4348a99

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : RemoveFolder_req.java
 ...
 * @version 1.0
 */
public class RemoveFolder_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public RemoveFolder_req(RemoveFolder_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(RemoveFolder_req object) {
        setFolder(object.getFolder());
     ...
     * @param    path    
     */
    public RemoveFolder_req(org.qualipso.advdoc.ws.client.storage.beans.FolderPath path,String folder) {
        setFolder(folder);
        setPath(path);
    }
    ...
    public String toString() {
        return this.toXML("RemoveFolder_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RemoveFolder_req)) {
            return false;
        }
        RemoveFolder_req value = (RemoveFolder_req)obj;
        if (!(value.folder.equals(this.folder))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo folder
        code = tdi.gen.TdiHashcode.concat(code,this.folder);
     ...
     */
    public static boolean equals(RemoveFolder_req[] __array1,RemoveFolder_req[] __array2) {
    ...
    /**
     * Lectura del atributo folder
     * @return   Valor del atributo folder
     */
    public String getFolder() { return this.folder; }

    /**
     * Escritura del atributo folder
     * @param    valor    Nuevo valor del atributo folder
     */
    public void setFolder(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.folder = valor;
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.folder = input.extract_String();
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'RemoveFolder_req';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.storage.beans';\n");
    }
    js.append(varName+".folder = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.folder)+"';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"RemoveFolder_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<RemoveFolder_req type=\"RemoveFolder_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<folder type=\"string\">"+tdi.text.StringUtil.escapeXML(this.folder,false)+"</folder>");
    } else {
        xml.append(_indentar(indents+1)+"<folder type=\"string\">"+this.folder+"</folder>");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</RemoveFolder_req>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("folder", tdi.text.StringUtil.sustituyeUnicode(this.folder));
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_folder = __params__.get("folder");
    if (__object_folder == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo folder");
    }
    if (!(__object_folder instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo folder no es de tipo String");
    }
    setFolder((String)__object_folder);
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"folder");
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        writer.write("<folder>");
        writer.write(tdi.text.StringUtil.escapeXML(this.getFolder(), false));
        writer.write("</folder>");
        writer.write("\n");
        writer.write("<path>");
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("folder");
        if (node != null && node.getContents() != null) {
            this.setFolder(node.getContents());
        }
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setFolder(json.getString("folder"));
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new RemoveFolder_req(this);
    }
    /**
