//397521203e5f0d9f8be1fcf83c0311

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : RemoveProperty_req.java
 ...
 * @version 1.0
 */
public class RemoveProperty_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public RemoveProperty_req(RemoveProperty_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(RemoveProperty_req object) {
     ...
     * @param    resourceUri    
     */
    public RemoveProperty_req(String resourceUri,String propertyUri) {
    ...
    public String toString() {
        return this.toXML("RemoveProperty_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RemoveProperty_req)) {
            return false;
        }
        RemoveProperty_req value = (RemoveProperty_req)obj;
     ...
     */
    public static boolean equals(RemoveProperty_req[] __array1,RemoveProperty_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'RemoveProperty_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"RemoveProperty_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<RemoveProperty_req type=\"RemoveProperty_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</RemoveProperty_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new RemoveProperty_req(this);
    }
    /**
