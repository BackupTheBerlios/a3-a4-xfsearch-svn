//a0fb9f481fb976924dd5ab397303981

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : RemoveProperty_resp.java
 ...
 * @version 1.0
 */
public class RemoveProperty_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public RemoveProperty_resp(RemoveProperty_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(RemoveProperty_resp object) {
     ...
     * @param    resourceUri    
     */
    public RemoveProperty_resp(String resourceUri) {
    ...
    public String toString() {
        return this.toXML("RemoveProperty_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RemoveProperty_resp)) {
            return false;
        }
        RemoveProperty_resp value = (RemoveProperty_resp)obj;
     ...
     */
    public static boolean equals(RemoveProperty_resp[] __array1,RemoveProperty_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'RemoveProperty_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"RemoveProperty_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<RemoveProperty_resp type=\"RemoveProperty_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</RemoveProperty_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new RemoveProperty_resp(this);
    }
    /**
