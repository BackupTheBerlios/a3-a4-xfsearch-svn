//6a879ebb2852289fdb3bfedd1e849

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenAddLiteralPropertyService.java
...
/**
 * Clase base para la operación AddLiteralProperty : Add a literal property to an existing resource
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenAddLiteralPropertyService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(AddLiteralProperty_req __inbean,AddLiteralProperty_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,AddLiteralProperty_req __inbean,AddLiteralProperty_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,AddLiteralProperty_req __inbean,ServletContext context) {
