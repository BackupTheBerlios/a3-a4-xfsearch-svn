//f9662db4ef2ddd1891cc108fe18c23

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetForgeListService.java
...
/**
 * Clase base para la operación GetForgeList : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetForgeListService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetForgeList_req __inbean,GetForgeList_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetForgeList_req __inbean,GetForgeList_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetForgeList_req __inbean,ServletContext context) {
