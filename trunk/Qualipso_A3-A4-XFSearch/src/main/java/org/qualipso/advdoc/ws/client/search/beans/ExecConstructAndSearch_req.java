//adcecb74878fce4495ddf0e846e533f0

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ExecConstructAndSearch_req.java
 ...
 * @version 1.0
 */
public class ExecConstructAndSearch_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public ExecConstructAndSearch_req() {
     ...
     */
    public ExecConstructAndSearch_req(ExecConstructAndSearch_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ExecConstructAndSearch_req object) {
        setConstruct(object.getConstruct());
     ...
     * @param    sparql    
     */
    public ExecConstructAndSearch_req(String sparql,String construct) {
    ...
    public String toString() {
        return this.toXML("ExecConstructAndSearch_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ExecConstructAndSearch_req)) {
            return false;
        }
        ExecConstructAndSearch_req value = (ExecConstructAndSearch_req)obj;
        if (!(value.construct.equals(this.construct))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo construct
        code = tdi.gen.TdiHashcode.concat(code,this.construct);
     ...
     */
    public static boolean equals(ExecConstructAndSearch_req[] __array1,ExecConstructAndSearch_req[] __array2) {
    ...
    /**
     * Lectura del atributo construct
     * @return   Valor del atributo construct
     */
    public String getConstruct() { return this.construct; }

    /**
     * Escritura del atributo construct
     * @param    valor    Nuevo valor del atributo construct
     */
    public void setConstruct(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.construct = valor;
        setChanged();
    }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.construct = input.extract_String();
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ExecConstructAndSearch_req';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.search.beans';\n");
    }
    js.append(varName+".construct = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.construct)+"';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ExecConstructAndSearch_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ExecConstructAndSearch_req type=\"ExecConstructAndSearch_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<construct type=\"string\">"+tdi.text.StringUtil.escapeXML(this.construct,false)+"</construct>");
    } else {
        xml.append(_indentar(indents+1)+"<construct type=\"string\">"+this.construct+"</construct>");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ExecConstructAndSearch_req>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("construct", tdi.text.StringUtil.sustituyeUnicode(this.construct));
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_construct = __params__.get("construct");
    if (__object_construct == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo construct");
    }
    if (!(__object_construct instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo construct no es de tipo String");
    }
    setConstruct((String)__object_construct);
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"construct");
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        ...
        writer.write(tdi.text.StringUtil.escapeXML(this.getConstruct(), false));
        writer.write("</construct>");
        writer.write("\n");
        writer.write("<sparql>");
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("construct");
        if (node != null && node.getContents() != null) {
            this.setConstruct(node.getContents());
        }
    ...
    public void toJSON(JSONObject json) throws JSONException {
        JSONObject jObject;
        json.put("construct",this.getConstruct());
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setConstruct(json.getString("construct"));
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new ExecConstructAndSearch_req(this);
    }
    /**
    ...
    public void copyFrom(Object source) throws ClassCastException {
        if (!(source instanceof ExecConstructAndSearch_req)) {
            throw new ClassCastException(getClass().getName()+".copyFrom() El objeto de copia es de la clase "+source.getClass().getName());
        }
        ExecConstructAndSearch_req bean = (ExecConstructAndSearch_req)source;
        this.set(bean);
    }
