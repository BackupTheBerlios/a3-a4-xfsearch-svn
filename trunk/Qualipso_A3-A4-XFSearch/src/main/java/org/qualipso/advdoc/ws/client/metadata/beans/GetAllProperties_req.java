//9bcd74e5b5e53d399f340212174552f

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetAllProperties_req.java
 ...
 * @version 1.0
 */
public class GetAllProperties_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetAllProperties_req(GetAllProperties_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetAllProperties_req object) {
     ...
     * @param    classUri    
     */
    public GetAllProperties_req(String classUri) {
    ...
    public String toString() {
        return this.toXML("GetAllProperties_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetAllProperties_req)) {
            return false;
        }
        GetAllProperties_req value = (GetAllProperties_req)obj;
     ...
     */
    public static boolean equals(GetAllProperties_req[] __array1,GetAllProperties_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetAllProperties_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetAllProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetAllProperties_req type=\"GetAllProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetAllProperties_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetAllProperties_req(this);
    }
    /**
