//7e19af728d5957ec84838f99fb127f

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetSubClassesService.java
...
/**
 * Clase base para la operación GetSubClasses : Get subclasses of a given class
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetSubClassesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetSubClasses_req __inbean,GetSubClasses_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetSubClasses_req __inbean,GetSubClasses_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetSubClasses_req __inbean,ServletContext context) {
