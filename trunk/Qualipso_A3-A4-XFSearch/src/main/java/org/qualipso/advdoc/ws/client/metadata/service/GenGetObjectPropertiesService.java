//fddbf4bac5f8eaf389edf6c0352ff492

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetObjectPropertiesService.java
...
/**
 * Clase base para la operación GetObjectProperties : Get all object properties of a given class
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetObjectPropertiesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetObjectProperties_req __inbean,GetObjectProperties_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetObjectProperties_req __inbean,GetObjectProperties_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetObjectProperties_req __inbean,ServletContext context) {
