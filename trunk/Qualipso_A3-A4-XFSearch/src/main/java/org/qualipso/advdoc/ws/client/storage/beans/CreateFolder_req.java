//b57db2d47ef3f4c361f2a86759c137

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : CreateFolder_req.java
 ...
 * @version 1.0
 */
public class CreateFolder_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public CreateFolder_req(CreateFolder_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(CreateFolder_req object) {
     ...
     * @param    path    
     */
    public CreateFolder_req(org.qualipso.advdoc.ws.client.storage.beans.FolderPath path,String folder) {
        setFolder(folder);
        setPath(path);
    }
    ...
    public String toString() {
        return this.toXML("CreateFolder_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CreateFolder_req)) {
            return false;
        }
        CreateFolder_req value = (CreateFolder_req)obj;
     ...
     */
    public static boolean equals(CreateFolder_req[] __array1,CreateFolder_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'CreateFolder_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"CreateFolder_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<CreateFolder_req type=\"CreateFolder_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</CreateFolder_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new CreateFolder_req(this);
    }
    /**
