//a83f724d5effb447c8b3dc96feae57

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenSearchCrossForgeService.java
...
/**
 * Clase base para la operación SearchCrossForge : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenSearchCrossForgeService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(SearchCrossForge_req __inbean,SearchCrossForge_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,SearchCrossForge_req __inbean,SearchCrossForge_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,SearchCrossForge_req __inbean,ServletContext context) {
