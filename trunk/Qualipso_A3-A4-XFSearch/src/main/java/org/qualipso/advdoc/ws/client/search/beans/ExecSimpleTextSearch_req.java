//5bfa937b93c9371dda29a2b7ddbb78

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ExecSimpleTextSearch_req.java
 ...
 * @version 1.0
 */
public class ExecSimpleTextSearch_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public ExecSimpleTextSearch_req() {
     ...
     */
    public ExecSimpleTextSearch_req(ExecSimpleTextSearch_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ExecSimpleTextSearch_req object) {
     ...
     * @param    textSearch    
     */
    public ExecSimpleTextSearch_req(String textSearch) {
    ...
    public String toString() {
        return this.toXML("ExecSimpleTextSearch_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ExecSimpleTextSearch_req)) {
            return false;
        }
        ExecSimpleTextSearch_req value = (ExecSimpleTextSearch_req)obj;
     ...
     */
    public static boolean equals(ExecSimpleTextSearch_req[] __array1,ExecSimpleTextSearch_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ExecSimpleTextSearch_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ExecSimpleTextSearch_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ExecSimpleTextSearch_req type=\"ExecSimpleTextSearch_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ExecSimpleTextSearch_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new ExecSimpleTextSearch_req(this);
    }
    /**
