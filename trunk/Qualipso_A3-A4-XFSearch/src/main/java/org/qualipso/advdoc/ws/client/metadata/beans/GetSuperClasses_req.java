//8b3ec466e7fc6d92e88c06859322e85

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetSuperClasses_req.java
 ...
 * @version 1.0
 */
public class GetSuperClasses_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetSuperClasses_req(GetSuperClasses_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetSuperClasses_req object) {
        setClassUri(object.getClassUri());
        setDirect(object.getDirect());
        setChanged();
    }
     ...
     * @param    direct    
     */
    public GetSuperClasses_req(String classUri,int direct) {
    ...
    public String toString() {
        return this.toXML("GetSuperClasses_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetSuperClasses_req)) {
            return false;
        }
        GetSuperClasses_req value = (GetSuperClasses_req)obj;
        if (!(value.classUri.equals(this.classUri))) {
            return false;
        }
        if (value.direct != this.direct) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo classUri
        code = tdi.gen.TdiHashcode.concat(code,this.classUri);
        // Concatenar con el hashcode del atributo direct
        code = tdi.gen.TdiHashcode.concat(code,this.direct);
        return code;
    }
     ...
     */
    public static boolean equals(GetSuperClasses_req[] __array1,GetSuperClasses_req[] __array2) {
    ...
    /**
     * Lectura del atributo classUri
     * @return   Valor del atributo classUri
     */
    public String getClassUri() { return this.classUri; }

    /**
     * Escritura del atributo classUri
     * @param    valor    Nuevo valor del atributo classUri
     */
    public void setClassUri(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.classUri = valor;
    ...
    /**
     * Lectura del atributo direct
     * @return   Valor del atributo direct
     */
    public int getDirect() { return this.direct; }

    /**
     * Escritura del atributo direct
     * @param    valor    Nuevo valor del atributo direct
     */
    public void setDirect(int valor) { 
        this.direct = valor;
        setChanged();
    }
  ...
  public void serialize(TdiOutputSerializer output) {
    output.append(this.classUri);
    output.append(this.direct);
  }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.classUri = input.extract_String();
    this.direct = input.extract_int();
    setChanged();
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetSuperClasses_req';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.metadata.beans';\n");
    }
    js.append(varName+".classUri = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.classUri)+"';\n");
    js.append(varName+".direct = "+this.direct+";\n");
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetSuperClasses_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetSuperClasses_req type=\"GetSuperClasses_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<classUri type=\"string\">"+tdi.text.StringUtil.escapeXML(this.classUri,false)+"</classUri>");
    } else {
        xml.append(_indentar(indents+1)+"<classUri type=\"string\">"+this.classUri+"</classUri>");
    }

    xml.append("\n");
    xml.append(_indentar(indents+1)+"<direct type=\"int\">"+this.direct+"</direct>");
    xml.append("\n");
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"</"+tag+">");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents)+"</GetSuperClasses_req>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("classUri", tdi.text.StringUtil.sustituyeUnicode(this.classUri));
    __struct__.put("direct", new Integer(direct));
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_classUri = __params__.get("classUri");
    if (__object_classUri == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo classUri");
    }
    if (!(__object_classUri instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo classUri no es de tipo String");
    }
    setClassUri((String)__object_classUri);
    Object __object_direct = __params__.get("direct");
    if (__object_direct == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo direct");
    }
    if (!(__object_direct instanceof Integer)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo direct no es de tipo Integer");
    }
    Integer __int_direct = (Integer)__object_direct;
    setDirect(__int_direct.intValue());
    setChanged();
  }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"classUri");
    ...
    {
      String __v = "0";
      org.w3c.dom.Element __e = getNodeByName(__node,"direct");
      if (__e != null && __e.getChildNodes().item(0) != null) {
        __v = __e.getChildNodes().item(0).getNodeValue();
      }
      setDirect(Integer.parseInt(__v));
    }
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        ...
        writer.write(tdi.text.StringUtil.escapeXML(this.getClassUri(), false));
        writer.write("</classUri>");
        writer.write("\n");
        writer.write("<direct>");
        writer.write(Integer.toString(this.getDirect()));
        writer.write("</direct>");
        writer.write("\n");
    }
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("classUri");
        if (node != null && node.getContents() != null) {
            this.setClassUri(node.getContents());
        }

        node = beanNode.getFirstChildByName("direct");
        if (node != null && node.getContents() != null) {
            this.setDirect(Integer.parseInt(node.getContents()));
        }
    ...
    public void toJSON(JSONObject json) throws JSONException {
        JSONObject jObject;
        json.put("classUri",this.getClassUri());
        json.put("direct",this.getDirect());
        JSONArray jArray;
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setClassUri(json.getString("classUri"));
        this.setDirect(json.getInt("direct"));
        JSONArray jArray;
        JSONArray jObjectArray;
    }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetSuperClasses_req(this);
    }
    /**
