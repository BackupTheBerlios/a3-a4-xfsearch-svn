//99c5393a6fa9aff76f2b9d6ea84f5e9

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : CreateAnonymousResource_req.java
 ...
 * @version 1.0
 */
public class CreateAnonymousResource_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public CreateAnonymousResource_req() {
     ...
     */
    public CreateAnonymousResource_req(CreateAnonymousResource_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(CreateAnonymousResource_req object) {
        setChanged();
    }
    ...
    public String toString() {
        return this.toXML("CreateAnonymousResource_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CreateAnonymousResource_req)) {
            return false;
        }
        CreateAnonymousResource_req value = (CreateAnonymousResource_req)obj;
        return true;
    }
     ...
     */
    public static boolean equals(CreateAnonymousResource_req[] __array1,CreateAnonymousResource_req[] __array2) {
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "CreateAnonymousResource_req <BR>",
            };
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'CreateAnonymousResource_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"CreateAnonymousResource_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<CreateAnonymousResource_req type=\"CreateAnonymousResource_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</CreateAnonymousResource_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new CreateAnonymousResource_req(this);
    }
    /**
    ...
    public void copyFrom(Object source) throws ClassCastException {
        if (!(source instanceof CreateAnonymousResource_req)) {
            throw new ClassCastException(getClass().getName()+".copyFrom() El objeto de copia es de la clase "+source.getClass().getName());
        }
        CreateAnonymousResource_req bean = (CreateAnonymousResource_req)source;
        this.set(bean);
    }
