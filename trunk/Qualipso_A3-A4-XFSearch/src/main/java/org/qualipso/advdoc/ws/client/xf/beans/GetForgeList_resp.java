//f829fac0c6982ac38283cca3cf4661d

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetForgeList_resp.java
 ...
 * @version 1.0
 */
public class GetForgeList_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetForgeList_resp(GetForgeList_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetForgeList_resp object) {
        this.forges.clear();
     ...
     * @param    forges    
     */
    public GetForgeList_resp(org.qualipso.advdoc.ws.client.xf.beans.Forge[] forges) {
    ...
    public String toString() {
        return this.toXML("GetForgeList_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetForgeList_resp)) {
            return false;
        }
        GetForgeList_resp value = (GetForgeList_resp)obj;
     ...
     */
    public static boolean equals(GetForgeList_resp[] __array1,GetForgeList_resp[] __array2) {
    ...
    /**
     * Eliminar el elemento i-ésimo del atributo forges
...
public     boolean removeForges(int position) {
    ...
    /**
     * Número de elementos en el atributo forges
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetForgeList_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetForgeList_resp\" package=\"org.qualipso.advdoc.ws.client.xf.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetForgeList_resp type=\"GetForgeList_resp\" package=\"org.qualipso.advdoc.ws.client.xf.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetForgeList_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetForgeList_resp(this);
    }
    /**
