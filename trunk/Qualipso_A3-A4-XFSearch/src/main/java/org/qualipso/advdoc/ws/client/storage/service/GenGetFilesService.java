//4562fc96cd9d612d77bbd53dfc829dfb

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetFilesService.java
...
/**
 * Clase base para la operación GetFiles : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetFilesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetFiles_req __inbean,GetFiles_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetFiles_req __inbean,GetFiles_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetFiles_req __inbean,ServletContext context) {
