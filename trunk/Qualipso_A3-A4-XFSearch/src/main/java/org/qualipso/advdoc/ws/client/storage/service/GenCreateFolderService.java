//80a7244bc132bc5221a9e81bbc03e21

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenCreateFolderService.java
...
/**
 * Clase base para la operación CreateFolder : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenCreateFolderService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(CreateFolder_req __inbean,CreateFolder_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,CreateFolder_req __inbean,CreateFolder_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,CreateFolder_req __inbean,ServletContext context) {
