//8dd1d529a98eb999e64143ee9f792e6f

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetEquivalentClassesService.java
...
/**
 * Clase base para la operación GetEquivalentClasses : Get equivalent classes to a given one
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetEquivalentClassesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetEquivalentClasses_req __inbean,GetEquivalentClasses_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetEquivalentClasses_req __inbean,GetEquivalentClasses_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetEquivalentClasses_req __inbean,ServletContext context) {
