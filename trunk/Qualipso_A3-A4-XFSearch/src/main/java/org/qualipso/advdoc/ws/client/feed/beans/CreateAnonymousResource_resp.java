//ed2beb3da84a43a4971837eea2dcbeab

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : CreateAnonymousResource_resp.java
 ...
 * @version 1.0
 */
public class CreateAnonymousResource_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public CreateAnonymousResource_resp() {
     ...
     */
    public CreateAnonymousResource_resp(CreateAnonymousResource_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(CreateAnonymousResource_resp object) {
        setAnonymousId(object.getAnonymousId());
        setChanged();
    }
     ...
     * @param    anonymousId    
     */
    public CreateAnonymousResource_resp(String anonymousId) {
    ...
    public String toString() {
        return this.toXML("CreateAnonymousResource_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CreateAnonymousResource_resp)) {
            return false;
        }
        CreateAnonymousResource_resp value = (CreateAnonymousResource_resp)obj;
        if (!(value.anonymousId.equals(this.anonymousId))) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo anonymousId
        code = tdi.gen.TdiHashcode.concat(code,this.anonymousId);
        return code;
    }
     ...
     */
    public static boolean equals(CreateAnonymousResource_resp[] __array1,CreateAnonymousResource_resp[] __array2) {
    ...
    /**
     * Lectura del atributo anonymousId
     * @return   Valor del atributo anonymousId
     */
    public String getAnonymousId() { return this.anonymousId; }

    /**
     * Escritura del atributo anonymousId
     * @param    valor    Nuevo valor del atributo anonymousId
     */
    public void setAnonymousId(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.anonymousId = valor;
        setChanged();
    }
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "CreateAnonymousResource_resp <BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string anonymousId<BR>",
            };
  ...
  public void serialize(TdiOutputSerializer output) {
    output.append(this.anonymousId);
  }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.anonymousId = input.extract_String();
    setChanged();
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'CreateAnonymousResource_resp';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.feed.beans';\n");
    }
    js.append(varName+".anonymousId = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.anonymousId)+"';\n");
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"CreateAnonymousResource_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<CreateAnonymousResource_resp type=\"CreateAnonymousResource_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<anonymousId type=\"string\">"+tdi.text.StringUtil.escapeXML(this.anonymousId,false)+"</anonymousId>");
    } else {
        xml.append(_indentar(indents+1)+"<anonymousId type=\"string\">"+this.anonymousId+"</anonymousId>");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</CreateAnonymousResource_resp>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("anonymousId", tdi.text.StringUtil.sustituyeUnicode(this.anonymousId));
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_anonymousId = __params__.get("anonymousId");
    if (__object_anonymousId == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo anonymousId");
    }
    if (!(__object_anonymousId instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo anonymousId no es de tipo String");
    }
    setAnonymousId((String)__object_anonymousId);
    setChanged();
  }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"anonymousId");
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        writer.write("<anonymousId>");
        writer.write(tdi.text.StringUtil.escapeXML(this.getAnonymousId(), false));
        writer.write("</anonymousId>");
        writer.write("\n");
    }
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("anonymousId");
        if (node != null && node.getContents() != null) {
            this.setAnonymousId(node.getContents());
        }
    ...
    public void toJSON(JSONObject json) throws JSONException {
        JSONObject jObject;
        json.put("anonymousId",this.getAnonymousId());
        JSONArray jArray;
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setAnonymousId(json.getString("anonymousId"));
        JSONArray jArray;
        JSONArray jObjectArray;
    }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new CreateAnonymousResource_resp(this);
    }
    /**
    ...
    public void copyFrom(Object source) throws ClassCastException {
        if (!(source instanceof CreateAnonymousResource_resp)) {
            throw new ClassCastException(getClass().getName()+".copyFrom() El objeto de copia es de la clase "+source.getClass().getName());
        }
        CreateAnonymousResource_resp bean = (CreateAnonymousResource_resp)source;
        this.set(bean);
    }
