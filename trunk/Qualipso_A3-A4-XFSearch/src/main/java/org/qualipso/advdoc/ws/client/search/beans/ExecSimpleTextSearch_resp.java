//6e07ca548d29aab0546f22e1cb0b2

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ExecSimpleTextSearch_resp.java
 ...
 * @version 1.0
 */
public class ExecSimpleTextSearch_resp extends org.qualipso.advdoc.ws.client.search.beans.ExecQuery_resp implements es.tid.serial.TdiBean {
     ...
     */
    public ExecSimpleTextSearch_resp() {
     ...
     */
    public ExecSimpleTextSearch_resp(ExecSimpleTextSearch_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ExecSimpleTextSearch_resp object) {
        super.set(object);
        setChanged();
    }
     ...
     */
    public ExecSimpleTextSearch_resp(org.qualipso.advdoc.ws.client.search.beans.SPARQLResult result,String sparql,double time) {
    ...
    public String toString() {
        return this.toXML("ExecSimpleTextSearch_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ExecSimpleTextSearch_resp)) {
            return false;
        }
        ExecSimpleTextSearch_resp value = (ExecSimpleTextSearch_resp)obj;
        if (!super.equals(obj)) {
            return false;
        }
        return true;
     ...
     */
    public static boolean equals(ExecSimpleTextSearch_resp[] __array1,ExecSimpleTextSearch_resp[] __array2) {
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "ExecSimpleTextSearch_resp  extends ExecQuery_resp<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string sparql (*)<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;double time (*)<BR>",
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ExecSimpleTextSearch_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ExecSimpleTextSearch_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ExecSimpleTextSearch_resp type=\"ExecSimpleTextSearch_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ExecSimpleTextSearch_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new ExecSimpleTextSearch_resp(this);
    }
    /**
