//e6a9aa2ebac716c9641c8ba57ccf258

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ExecSPARQL_resp.java
 ...
 * @version 1.0
 */
public class ExecSPARQL_resp extends org.qualipso.advdoc.ws.client.search.beans.ExecQuery_resp implements es.tid.serial.TdiBean {
     ...
     */
    public ExecSPARQL_resp(ExecSPARQL_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ExecSPARQL_resp object) {
        super.set(object);
        setChanged();
    }
     ...
     */
    public ExecSPARQL_resp(org.qualipso.advdoc.ws.client.search.beans.SPARQLResult result,String sparql,double time) {
    ...
    public String toString() {
        return this.toXML("ExecSPARQL_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ExecSPARQL_resp)) {
            return false;
        }
        ExecSPARQL_resp value = (ExecSPARQL_resp)obj;
        if (!super.equals(obj)) {
            return false;
        }
        return true;
     ...
     */
    public static boolean equals(ExecSPARQL_resp[] __array1,ExecSPARQL_resp[] __array2) {
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "ExecSPARQL_resp  extends ExecQuery_resp<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string sparql (*)<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;double time (*)<BR>",
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ExecSPARQL_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ExecSPARQL_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ExecSPARQL_resp type=\"ExecSPARQL_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ExecSPARQL_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new ExecSPARQL_resp(this);
    }
    /**
