//d7edca8e9bbcadba941d1512afcc08a

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetAllProperties_resp.java
...
/**
 * 
 * @composed 1 - 1 org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp
 * @composed 1 - 1 org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp
 * @author FRAWA
 * @version 1.0
 */
public class GetAllProperties_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     * 
     */
    protected org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp datatypeProperties = new org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp();
    /**
     * 
     */
    protected org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp objectProperties = new org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp();
     ...
     */
    public GetAllProperties_resp() {
        // Registrarse como Observer de los atributos hijos
        this.datatypeProperties.addObserver(this);
     ...
     */
    public GetAllProperties_resp(GetAllProperties_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetAllProperties_resp object) {
        getDatatypeProperties().set(object.getDatatypeProperties());
        getObjectProperties().set(object.getObjectProperties());
        setChanged();
    }
     ...
     */
    public GetAllProperties_resp(org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp datatypeProperties,org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp objectProperties) {
        setDatatypeProperties(datatypeProperties);
    ...
    public String toString() {
        return this.toXML("GetAllProperties_resp",0);
    }
    ...
    public boolean valida(java.util.ArrayList errores) {
        ...
        boolean ok = true;
        ok = ok && this.getDatatypeProperties().valida(errores);
        ok = ok && this.getObjectProperties().valida(errores);
        return ok;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetAllProperties_resp)) {
            return false;
        }
        GetAllProperties_resp value = (GetAllProperties_resp)obj;
        if (!(value.datatypeProperties.equals(this.datatypeProperties))) {
            return false;
        }
        if (!(value.objectProperties.equals(this.objectProperties))) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo datatypeProperties
        code = tdi.gen.TdiHashcode.concat(code,this.datatypeProperties);
        // Concatenar con el hashcode del atributo objectProperties
        code = tdi.gen.TdiHashcode.concat(code,this.objectProperties);
        return code;
    }
     ...
     */
    public static boolean equals(GetAllProperties_resp[] __array1,GetAllProperties_resp[] __array2) {
    ...
    /**
     * Lectura del atributo datatypeProperties
     * @return   Valor del atributo datatypeProperties
     */
    public org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp getDatatypeProperties() { return this.datatypeProperties; }

    /**
     * Escritura del atributo datatypeProperties
     * @param    valor    Nuevo valor del atributo datatypeProperties
     */
    public void setDatatypeProperties(org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp valor) { 
        if (valor == null) {
            valor = new org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp();
        }
        // Desregistrarse como Observer del objeto anterior
        if (this.datatypeProperties != null) this.datatypeProperties.deleteObserver(this);
        this.datatypeProperties = valor;
        setChanged();
        // Registrarse como Observer del nuevo objeto
        if (this.datatypeProperties != null) this.datatypeProperties.addObserver(this);
    }

    /**
     * Lectura del atributo objectProperties
     * @return   Valor del atributo objectProperties
     */
    public org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp getObjectProperties() { return this.objectProperties; }

    /**
     * Escritura del atributo objectProperties
     * @param    valor    Nuevo valor del atributo objectProperties
     */
    public void setObjectProperties(org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp valor) { 
        if (valor == null) {
            valor = new org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp();
        }
        // Desregistrarse como Observer del objeto anterior
        if (this.objectProperties != null) this.objectProperties.deleteObserver(this);
        this.objectProperties = valor;
        setChanged();
        // Registrarse como Observer del nuevo objeto
        if (this.objectProperties != null) this.objectProperties.addObserver(this);
    }
    ...
    public void fillSampleData() {
        this.datatypeProperties.fillSampleData();
        this.objectProperties.fillSampleData();
    }
  ...
  public void serialize(TdiOutputSerializer output) {
    output.append(this.datatypeProperties);
    output.append(this.objectProperties);
  }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    input.extract_object(datatypeProperties);
    input.extract_object(objectProperties);
    setChanged();
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetAllProperties_resp';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.metadata.beans';\n");
    }
    js.append(this.datatypeProperties.toJS(false,true,varName+".datatypeProperties",indents));
    js.append(this.objectProperties.toJS(false,true,varName+".objectProperties",indents));
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetAllProperties_resp\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetAllProperties_resp type=\"GetAllProperties_resp\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    xml.append(datatypeProperties.toXML("datatypeProperties", indents+1,ponerIndicesDeArrays,escaparStrings));
    xml.append("\n");
    xml.append(objectProperties.toXML("objectProperties", indents+1,ponerIndicesDeArrays,escaparStrings));
    xml.append("\n");
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"</"+tag+">");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents)+"</GetAllProperties_resp>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    java.util.Hashtable datatypeProperties__ht__ = (java.util.Hashtable)datatypeProperties.toRPC();
    if (datatypeProperties!=null && !datatypeProperties.getClass().getName().equals(org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp.class.getName())) {
        datatypeProperties__ht__.put("__constructor__", datatypeProperties.getClass().getName());
    }
    __struct__.put("datatypeProperties", datatypeProperties__ht__);
    java.util.Hashtable objectProperties__ht__ = (java.util.Hashtable)objectProperties.toRPC();
    if (objectProperties!=null && !objectProperties.getClass().getName().equals(org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp.class.getName())) {
        objectProperties__ht__.put("__constructor__", objectProperties.getClass().getName());
    }
    __struct__.put("objectProperties", objectProperties__ht__);
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_datatypeProperties = __params__.get("datatypeProperties");
    if (__object_datatypeProperties == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo datatypeProperties");
    }
    if (!(__object_datatypeProperties instanceof java.util.Hashtable)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo datatypeProperties no es de tipo Hashtable");
    }
    java.util.Hashtable __hashtable_datatypeProperties = (java.util.Hashtable)__object_datatypeProperties;
    org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp __value_datatypeProperties;
    String datatypeProperties__constructor__ = (String)__hashtable_datatypeProperties.get("__constructor__");
    // Si existe el atributo __constructor__ crear el objeto de la clase indicada
    if (datatypeProperties__constructor__ == null || datatypeProperties__constructor__.length()==0) {
        __value_datatypeProperties = new org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp();
    } else {
        __value_datatypeProperties = (org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp)Class.forName(datatypeProperties__constructor__).newInstance();
    }
    __value_datatypeProperties.fromRPC(__hashtable_datatypeProperties);
    setDatatypeProperties(__value_datatypeProperties);
    Object __object_objectProperties = __params__.get("objectProperties");
    if (__object_objectProperties == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo objectProperties");
    }
    if (!(__object_objectProperties instanceof java.util.Hashtable)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo objectProperties no es de tipo Hashtable");
    }
    java.util.Hashtable __hashtable_objectProperties = (java.util.Hashtable)__object_objectProperties;
    org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp __value_objectProperties;
    String objectProperties__constructor__ = (String)__hashtable_objectProperties.get("__constructor__");
    // Si existe el atributo __constructor__ crear el objeto de la clase indicada
    if (objectProperties__constructor__ == null || objectProperties__constructor__.length()==0) {
        __value_objectProperties = new org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp();
    } else {
        __value_objectProperties = (org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp)Class.forName(objectProperties__constructor__).newInstance();
    }
    __value_objectProperties.fromRPC(__hashtable_objectProperties);
    setObjectProperties(__value_objectProperties);
    setChanged();
  }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      org.w3c.dom.Element __e = getNodeByName(__node,"datatypeProperties");
      org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp __v;
      if (__e != null) {
        if (__e.getAttribute("package") != null && __e.getAttribute("package").length() != 0) {
          __v = (org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp) Class.forName(__e.getAttribute("package")+"."+__e.getAttribute("type")).newInstance();
        } else {
          __v = new org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp();
        }
        __v.fromXML(__e);
      } else {
        __v = new org.qualipso.advdoc.ws.client.metadata.beans.GetDatatypeProperties_resp();
      }
      setDatatypeProperties(__v);
    }
    {
      org.w3c.dom.Element __e = getNodeByName(__node,"objectProperties");
      org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp __v;
      if (__e != null) {
        if (__e.getAttribute("package") != null && __e.getAttribute("package").length() != 0) {
          __v = (org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp) Class.forName(__e.getAttribute("package")+"."+__e.getAttribute("type")).newInstance();
        } else {
          __v = new org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp();
        }
        __v.fromXML(__e);
      } else {
        __v = new org.qualipso.advdoc.ws.client.metadata.beans.GetObjectProperties_resp();
      }
      setObjectProperties(__v);
    }
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        writer.write("<datatypeProperties>");
        this.getDatatypeProperties().toSOAP(writer);
        writer.write("</datatypeProperties>");
        writer.write("\n");
        writer.write("<objectProperties>");
        this.getObjectProperties().toSOAP(writer);
        writer.write("</objectProperties>");
        writer.write("\n");
    }
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("datatypeProperties");
        if (node != null && node.getContents() != null) {
            this.datatypeProperties.fromSOAP(node);
        }

        node = beanNode.getFirstChildByName("objectProperties");
        if (node != null && node.getContents() != null) {
            this.objectProperties.fromSOAP(node);
        }
    ...
    public void toJSON(JSONObject json) throws JSONException {
        ...
        this.getDatatypeProperties().toJSON(jObject);
        json.put("datatypeProperties",jObject);
        jObject = new JSONObject();
        this.getObjectProperties().toJSON(jObject);
        json.put("objectProperties",jObject);
        JSONArray jArray;
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.getDatatypeProperties().fromJSON(json.getJSONObject("datatypeProperties"));
        this.getObjectProperties().fromJSON(json.getJSONObject("objectProperties"));
        JSONArray jArray;
        JSONArray jObjectArray;
    }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetAllProperties_resp(this);
    }
    /**
