//e9ba5834e95b4eaa5f8f5c2ff2397b53

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetPropertyRange_resp.java
 ...
 * @version 1.0
 */
public class GetPropertyRange_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetPropertyRange_resp(GetPropertyRange_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetPropertyRange_resp object) {
        this.classes.clear();
        for (int i = 0;i < object.classes.size();i++) {
            addClasses(new org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement(object.getClasses(i)));
        }
        setChanged();
    }
     ...
     * @param    classes    
     */
    public GetPropertyRange_resp(org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[] classes) {
    ...
    public String toString() {
        return this.toXML("GetPropertyRange_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetPropertyRange_resp)) {
            return false;
        }
        GetPropertyRange_resp value = (GetPropertyRange_resp)obj;
     ...
     */
    public static boolean equals(GetPropertyRange_resp[] __array1,GetPropertyRange_resp[] __array2) {
    ...
    /**
     * Eliminar el elemento i-ésimo del atributo classes
...
public     boolean removeClasses(int position) {
    ...
    /**
     * Número de elementos en el atributo classes
     ...
     */
    public org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[] getClasses() {
        return (org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[])this.classes.toArray(new org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[this.classes.size()]);
    }
     ...
     */
    public org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement getClasses(int position) {
        return (org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement)this.classes.elementAt(position);
    }
     ...
     */
    public void setClasses(int position,org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement valor) {
        if (valor == null) {
     ...
     */
    public void setClasses(org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[] valores) {
     ...
     * @param    valor    Nuevo elemento
     */
    public void addClasses(org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement valor) {
        if (valor == null) {
            valor = new org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement();
        }
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "GetPropertyRange_resp <BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ResourceElement[] classes<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string comment<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string label<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string localName<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string namespace<BR>",
  ...
  public void serialize(TdiOutputSerializer output) {
    ...
    for (int i=0; i<this.classes.size(); i++) {
      output.append((org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement)this.classes.elementAt(i));
    }
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetPropertyRange_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetPropertyRange_resp\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetPropertyRange_resp type=\"GetPropertyRange_resp\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    xml.append(_indentar(indents+1)+"<classes type=\"org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[]\" size=\""+this.classes.size()+"\">");
    xml.append("\n");
    for (int i=0; i<this.classes.size(); i++) {
        String sufijo = (ponerIndicesDeArrays ? ""+i : "elemento");
      xml.append(((org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement)classes.elementAt(i)).toXML("classes"+"_"+sufijo, indents+2,ponerIndicesDeArrays,escaparStrings));
      xml.append("\n");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetPropertyRange_resp>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    ...
    for (int __i__ = 0;__i__ < classes.size();__i__++) {
        org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement __object__ = (org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement)classes.elementAt(__i__);
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetPropertyRange_resp(this);
    }
    /**
