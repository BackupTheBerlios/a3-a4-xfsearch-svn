//14f77fb0a16833ef552e8e31ddfdde0

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetSuperPropertiesService.java
...
/**
 * Clase base para la operación GetSuperProperties : Get superproperties of a given property
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetSuperPropertiesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetSuperProperties_req __inbean,GetSuperProperties_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetSuperProperties_req __inbean,GetSuperProperties_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetSuperProperties_req __inbean,ServletContext context) {
