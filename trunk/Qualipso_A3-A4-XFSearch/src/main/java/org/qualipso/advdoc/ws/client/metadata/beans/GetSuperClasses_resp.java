//7cc6caa46bec12f14586ee5e6877f622

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetSuperClasses_resp.java
 ...
 * @version 1.0
 */
public class GetSuperClasses_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    protected ObjectVector superclasses = new ObjectVector(10);
     ...
     */
    public GetSuperClasses_resp() {
        // Registrarse como Observer de los atributos hijos
        this.superclasses.addObserver(this);
    }
     ...
     */
    public GetSuperClasses_resp(GetSuperClasses_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetSuperClasses_resp object) {
        this.superclasses.clear();
        for (int i = 0;i < object.superclasses.size();i++) {
            addSuperclasses(new org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement(object.getSuperclasses(i)));
        }
        setChanged();
    }
     ...
     * @param    superclasses    
     */
    public GetSuperClasses_resp(org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[] superclasses) {
        for (int __i = 0;__i < superclasses.length;__i++) {
            addSuperclasses(superclasses[__i]);
        }
    }
    ...
    public String toString() {
        return this.toXML("GetSuperClasses_resp",0);
    }
    ...
    public boolean valida(java.util.ArrayList errores) {
        ...
        boolean ok = true;
        for (int i = 0;i < this.superclasses_size();i++) {
            ok = ok && this.getSuperclasses(i).valida(errores);
        }
        return ok;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetSuperClasses_resp)) {
            return false;
        }
        GetSuperClasses_resp value = (GetSuperClasses_resp)obj;
        if (value.superclasses.size() != this.superclasses.size()) {
            return false;
        }
        for (int i = 0;i < value.superclasses.size();i++) {
            if (!(value.getSuperclasses(i).equals(this.getSuperclasses(i)))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo superclasses
        for (int i = 0;i < superclasses.size();i++) {
            code = tdi.gen.TdiHashcode.concat(code,this.getSuperclasses(i));
        }
        return code;
    }
     ...
     */
    public static boolean equals(GetSuperClasses_resp[] __array1,GetSuperClasses_resp[] __array2) {
    ...
    /**
     * Vacia los elementos del atributo superclasses
     */
    public void clearSuperclasses() { this.superclasses.clear(); setChanged(); }

    /**
     * Eliminar el elemento i-ésimo del atributo superclasses
     * @param    position    Posición del elemento que se quiere eliminar
     * @return   false si no se puede eliminar
     */
public     boolean removeSuperclasses(int position) {
        return this.superclasses.remove(position);
    }

    /**
     * Número de elementos en el atributo superclasses
     * @return   Número de elementos
     */
    public int superclasses_size() { return this.superclasses.size(); }

    /**
     * Elementos del atributo superclasses
     * @return   Array de elementos
     */
    public org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[] getSuperclasses() {
        return (org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[])this.superclasses.toArray(new org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[this.superclasses.size()]);
    }

    /**
     * Obtener el elemento i-isimo del atributo superclasses
     * @param    position    Posicisn del elemento que se quiere obtener
     * @return   Elemento i-isimo
     */
    public org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement getSuperclasses(int position) {
        return (org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement)this.superclasses.elementAt(position);
    }

    /**
     * Modificar el elemento i-isimo del atributo superclasses
     * @param    position    Posicisn del elemento que se quiere modificar
     * @param    valor    Nuevo elemento
     */
    public void setSuperclasses(int position,org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement valor) {
        if (valor == null) {
            valor = new org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement();
        }
        this.superclasses.setElementAt(valor, position);
        setChanged();
    }

    /**
     * Modifica todos los elementos del atributo superclasses
     * @param    valores    Los nuevos elementos
     */
    public void setSuperclasses(org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[] valores) {
        this.superclasses = new ObjectVector(valores);
        this.superclasses.addObserver(this);
        setChanged();
    }

    /**
     * Aqade un nuevo elemento al atributo superclasses
     * @param    valor    Nuevo elemento
     */
    public void addSuperclasses(org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement valor) {
        if (valor == null) {
            valor = new org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement();
        }
        this.superclasses.addElement(valor);
        setChanged();
    }
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "GetSuperClasses_resp <BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ResourceElement[] superclasses<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string comment<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string label<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string localName<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string namespace<BR>",
  ...
  public void serialize(TdiOutputSerializer output) {
    output.append((int)this.superclasses.size());
    for (int i=0; i<this.superclasses.size(); i++) {
      output.append((org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement)this.superclasses.elementAt(i));
    }
  }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    {
        ...
        this.superclasses = new ObjectVector(len);
        this.superclasses.addObserver(this);
        for (int i = 0; i < len; i++) {
          ...
          this.superclasses.addElement(aux);
        }
    }
    setChanged();
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetSuperClasses_resp';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.metadata.beans';\n");
    }
    js.append(varName+".superclasses = new Array("+this.superclasses.size()+");\n");
    for (int i = 0;i < this.superclasses.size();i++) {
        TdiJavascriptable object = (TdiJavascriptable)this.superclasses.elementAt(i);
        js.append(object.toJS(false,true,varName+".superclasses["+i+"]",0));
    }
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetSuperClasses_resp\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetSuperClasses_resp type=\"GetSuperClasses_resp\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    xml.append(_indentar(indents+1)+"<superclasses type=\"org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement[]\" size=\""+this.superclasses.size()+"\">");
    xml.append("\n");
    for (int i=0; i<this.superclasses.size(); i++) {
        String sufijo = (ponerIndicesDeArrays ? ""+i : "elemento");
      xml.append(((org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement)superclasses.elementAt(i)).toXML("superclasses"+"_"+sufijo, indents+2,ponerIndicesDeArrays,escaparStrings));
      xml.append("\n");
    }
    xml.append(_indentar(indents+1));
    xml.append("</superclasses>");
    xml.append("\n");
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"</"+tag+">");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents)+"</GetSuperClasses_resp>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    java.util.Vector __vector_superclasses = new java.util.Vector();
    for (int __i__ = 0;__i__ < superclasses.size();__i__++) {
        org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement __object__ = (org.qualipso.advdoc.ws.client.metadata.beans.ResourceElement)superclasses.elementAt(__i__);
        __vector_superclasses.addElement(__object__.toRPC());
    }
    __struct__.put("superclasses",__vector_superclasses);
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_superclasses = __params__.get("superclasses");
    if (__object_superclasses == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo vector superclasses");
    }
    if (!(__object_superclasses instanceof java.util.Vector)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo superclasses no es de tipo Vector");
    }
    java.util.Vector __vector_superclasses = (java.util.Vector)__object_superclasses;
    for (int i = 0;i < __vector_superclasses.size();i++) {
        Object __element__ = __vector_superclasses.elementAt(i);
        if (!(__element__ instanceof java.util.Hashtable)) {
            throw new Exception(getClass().getName()+".fromRPC() El atributo superclasses no es de tipo Hashtable");
        }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      ...
      org.w3c.dom.Element __element = getNodeByName(__node,"superclasses");
      int __size = 0;
      if (__element != null) {
      ...
      for (int i = 0;i < __size;i++) {
        org.w3c.dom.Element __element2 = getNodeByName(__element,"superclasses_"+i);
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        writer.write("<superclasses>");
        writer.write("\n");
        for (int i = 0; i < superclasses_size(); i++) {
            writer.write("<ResourceElement>");
            writer.write("\n");
            this.getSuperclasses(i).toSOAP(writer);
            writer.write("</ResourceElement>");
            writer.write("\n");
        }
        writer.write("</superclasses>");
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("superclasses");
    ...
    public void toJSON(JSONObject json) throws JSONException {
        ...
        for (int i = 0;i < superclasses_size();i++) {
            ...
            this.getSuperclasses(i).toJSON(jObj_i);
            jObjectArray.put(jObj_i);
        }
        json.put("superclasses",jObjectArray);
    }
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        JSONArray jArray;
        JSONArray jObjectArray;
        jObjectArray = json.getJSONArray("superclasses");
        this.clearSuperclasses();
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetSuperClasses_resp(this);
    }
    /**
