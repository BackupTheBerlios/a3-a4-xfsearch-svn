//9efbb8e81c3e95effd36862136345052

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenLoadFileService.java
...
/**
 * Clase base para la operación LoadFile : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenLoadFileService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(LoadFile_req __inbean,LoadFile_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,LoadFile_req __inbean,LoadFile_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,LoadFile_req __inbean,ServletContext context) {
