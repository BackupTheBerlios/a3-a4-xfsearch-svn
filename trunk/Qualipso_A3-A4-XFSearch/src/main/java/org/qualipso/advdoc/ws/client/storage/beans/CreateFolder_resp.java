//2b3fdcb39d25515795aaffef984931

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : CreateFolder_resp.java
 ...
 * @version 1.0
 */
public class CreateFolder_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public CreateFolder_resp(CreateFolder_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(CreateFolder_resp object) {
     ...
     * @param    result    
     */
    public CreateFolder_resp(int result) {
        setResult(result);
    }
    ...
    public String toString() {
        return this.toXML("CreateFolder_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CreateFolder_resp)) {
            return false;
        }
        CreateFolder_resp value = (CreateFolder_resp)obj;
     ...
     */
    public static boolean equals(CreateFolder_resp[] __array1,CreateFolder_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'CreateFolder_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"CreateFolder_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<CreateFolder_resp type=\"CreateFolder_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</CreateFolder_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new CreateFolder_resp(this);
    }
    /**
