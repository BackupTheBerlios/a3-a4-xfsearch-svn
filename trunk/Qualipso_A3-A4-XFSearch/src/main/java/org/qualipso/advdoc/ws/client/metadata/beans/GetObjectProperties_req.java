//d42ea2534976817992f4f3188323a65e

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetObjectProperties_req.java
 ...
 * @version 1.0
 */
public class GetObjectProperties_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetObjectProperties_req() {
     ...
     */
    public GetObjectProperties_req(GetObjectProperties_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetObjectProperties_req object) {
     ...
     * @param    classUri    
     */
    public GetObjectProperties_req(String classUri) {
    ...
    public String toString() {
        return this.toXML("GetObjectProperties_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetObjectProperties_req)) {
            return false;
        }
        GetObjectProperties_req value = (GetObjectProperties_req)obj;
     ...
     */
    public static boolean equals(GetObjectProperties_req[] __array1,GetObjectProperties_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetObjectProperties_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetObjectProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetObjectProperties_req type=\"GetObjectProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetObjectProperties_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetObjectProperties_req(this);
    }
    /**
