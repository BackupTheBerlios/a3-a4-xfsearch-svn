//43a8ffec827f132325f727751bcb30eb

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ExecAsk_req.java
 ...
 * @version 1.0
 */
public class ExecAsk_req extends org.qualipso.advdoc.ws.client.search.beans.ExecSearch_req implements es.tid.serial.TdiBean {
     ...
     */
    public ExecAsk_req(ExecAsk_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ExecAsk_req object) {
        super.set(object);
        setChanged();
    }
     ...
     * @param    textConditions    (heredado de ExecSearch_req)
     */
    public ExecAsk_req(String baseNamespace,org.qualipso.advdoc.ws.client.search.beans.Namespace[] namespaces,int distinct,String[] variables,String[] conditions,String orderBy,int limit,int offset,org.qualipso.advdoc.ws.client.search.beans.OptionalConditionGroup[] optionalConditions,org.qualipso.advdoc.ws.client.search.beans.TextSearchCondition[] textConditions) {
        super(baseNamespace,namespaces,distinct,variables,conditions,orderBy,limit,offset,optionalConditions,textConditions);
    }
    ...
    public String toString() {
        return this.toXML("ExecAsk_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ExecAsk_req)) {
            return false;
        }
        ExecAsk_req value = (ExecAsk_req)obj;
        if (!super.equals(obj)) {
            return false;
        }
        return true;
     ...
     */
    public static boolean equals(ExecAsk_req[] __array1,ExecAsk_req[] __array2) {
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "ExecAsk_req  extends ExecQuery_req<BR>",
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ExecAsk_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ExecAsk_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ExecAsk_req type=\"ExecAsk_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ExecAsk_req>");
    }
    return xml.toString();
  }
