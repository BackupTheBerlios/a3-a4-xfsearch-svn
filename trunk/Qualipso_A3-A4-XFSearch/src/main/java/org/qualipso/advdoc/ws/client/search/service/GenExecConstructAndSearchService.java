//9debf88990420d6bd597e985259c9ec

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenExecConstructAndSearchService.java
...
/**
 * Clase base para la operación ExecConstructAndSearch : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenExecConstructAndSearchService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(ExecConstructAndSearch_req __inbean,ExecConstructAndSearch_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,ExecConstructAndSearch_req __inbean,ExecConstructAndSearch_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,ExecConstructAndSearch_req __inbean,ServletContext context) {
