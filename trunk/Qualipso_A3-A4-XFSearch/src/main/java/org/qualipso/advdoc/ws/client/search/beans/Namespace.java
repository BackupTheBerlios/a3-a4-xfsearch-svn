//37b76e5e16c4bb2fc94c7309f33a07a

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : Namespace.java
 ...
 * @version 1.0
 */
public class Namespace extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public Namespace(Namespace object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(Namespace object) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(value.prefix.equals(this.prefix))) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        // Concatenar con el hashcode del atributo prefix
        code = tdi.gen.TdiHashcode.concat(code,this.prefix);
        return code;
    }
     ...
     */
    public static boolean equals(Namespace[] __array1,Namespace[] __array2) {
    ...
    /**
     * Lectura del atributo prefix
     * @return   Valor del atributo prefix
     */
    public String getPrefix() { return this.prefix; }

    /**
     * Escritura del atributo prefix
     * @param    valor    Nuevo valor del atributo prefix
     */
    public void setPrefix(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.prefix = valor;
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    ...
    this.prefix = input.extract_String();
    setChanged();
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'Namespace';\n");
    ...
    js.append(varName+".prefix = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.prefix)+"';\n");
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"Namespace\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<Namespace type=\"Namespace\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    xml.append("\n");
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<prefix type=\"string\">"+tdi.text.StringUtil.escapeXML(this.prefix,false)+"</prefix>");
    } else {
        xml.append(_indentar(indents+1)+"<prefix type=\"string\">"+this.prefix+"</prefix>");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</Namespace>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    ...
    __struct__.put("prefix", tdi.text.StringUtil.sustituyeUnicode(this.prefix));
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    ...
    Object __object_prefix = __params__.get("prefix");
    if (__object_prefix == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo prefix");
    }
    if (!(__object_prefix instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo prefix no es de tipo String");
    }
    setPrefix((String)__object_prefix);
    setChanged();
  }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    ...
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"prefix");
      if (__e != null && __e.getChildNodes().item(0) != null) {
        __v = __e.getChildNodes().item(0).getNodeValue();
      }
      setPrefix(__v);
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        ...
        writer.write("\n");
        writer.write("<prefix>");
        writer.write(tdi.text.StringUtil.escapeXML(this.getPrefix(), false));
        writer.write("</prefix>");
        writer.write("\n");
    }
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("prefix");
        if (node != null && node.getContents() != null) {
            this.setPrefix(node.getContents());
        }
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        ...
        this.setPrefix(json.getString("prefix"));
        JSONArray jArray;
        JSONArray jObjectArray;
    }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
    ...
    public void copyFrom(Object source) throws ClassCastException {
        ...
        Namespace bean = (Namespace)source;
        this.set(bean);
    }
