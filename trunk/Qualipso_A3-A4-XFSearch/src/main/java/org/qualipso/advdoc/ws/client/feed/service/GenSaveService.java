//793d44543af337b14ecaf2c9d78d3f98

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenSaveService.java
...
/**
 * Clase base para la operación Save : Save data to permanent storage
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenSaveService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(Save_req __inbean,Save_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,Save_req __inbean,Save_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,Save_req __inbean,ServletContext context) {
