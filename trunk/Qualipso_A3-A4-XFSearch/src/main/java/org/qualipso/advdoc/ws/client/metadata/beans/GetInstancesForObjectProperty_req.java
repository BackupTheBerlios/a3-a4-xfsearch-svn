//98b1b5eb46d28edfb88a36a65e906

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetInstancesForObjectProperty_req.java
 ...
 * @version 1.0
 */
public class GetInstancesForObjectProperty_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetInstancesForObjectProperty_req() {
     ...
     */
    public GetInstancesForObjectProperty_req(GetInstancesForObjectProperty_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetInstancesForObjectProperty_req object) {
     ...
     * @param    propertyURI    
     */
    public GetInstancesForObjectProperty_req(String propertyURI) {
    ...
    public String toString() {
        return this.toXML("GetInstancesForObjectProperty_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetInstancesForObjectProperty_req)) {
            return false;
        }
        GetInstancesForObjectProperty_req value = (GetInstancesForObjectProperty_req)obj;
     ...
     */
    public static boolean equals(GetInstancesForObjectProperty_req[] __array1,GetInstancesForObjectProperty_req[] __array2) {
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "GetInstancesForObjectProperty_req <BR>",
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetInstancesForObjectProperty_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetInstancesForObjectProperty_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetInstancesForObjectProperty_req type=\"GetInstancesForObjectProperty_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetInstancesForObjectProperty_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetInstancesForObjectProperty_req(this);
    }
    /**
    ...
    public void copyFrom(Object source) throws ClassCastException {
        if (!(source instanceof GetInstancesForObjectProperty_req)) {
            throw new ClassCastException(getClass().getName()+".copyFrom() El objeto de copia es de la clase "+source.getClass().getName());
        }
        GetInstancesForObjectProperty_req bean = (GetInstancesForObjectProperty_req)source;
        this.set(bean);
    }
