//6fd89f48377bf5fdcbb038b28be24

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetSubFoldersService.java
...
/**
 * Clase base para la operación GetSubFolders : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetSubFoldersService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetSubFolders_req __inbean,GetSubFolders_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetSubFolders_req __inbean,GetSubFolders_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetSubFolders_req __inbean,ServletContext context) {
