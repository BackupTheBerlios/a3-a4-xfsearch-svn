//5818a65b976632aa91fd27c037f79ce6

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenStoreBinaryFileService.java
...
/**
 * Clase base para la operación StoreBinaryFile : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenStoreBinaryFileService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(StoreBinaryFile_req __inbean,StoreBinaryFile_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,StoreBinaryFile_req __inbean,StoreBinaryFile_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,StoreBinaryFile_req __inbean,ServletContext context) {
