//26faeb2204ac5bf191d6d16a4cefac9

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ExecAsk_resp.java
 ...
 * @version 1.0
 */
public class ExecAsk_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public ExecAsk_resp(ExecAsk_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ExecAsk_resp object) {
     ...
     * @param    result    
     */
    public ExecAsk_resp(int result) {
        setResult(result);
    }
    ...
    public String toString() {
        return this.toXML("ExecAsk_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ExecAsk_resp)) {
            return false;
        }
        ExecAsk_resp value = (ExecAsk_resp)obj;
     ...
     */
    public static boolean equals(ExecAsk_resp[] __array1,ExecAsk_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ExecAsk_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ExecAsk_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ExecAsk_resp type=\"ExecAsk_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ExecAsk_resp>");
    }
    return xml.toString();
  }
