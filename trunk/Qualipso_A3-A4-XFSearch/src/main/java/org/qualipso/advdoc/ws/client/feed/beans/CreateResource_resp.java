//a2e6aac44c7c36fff43470692c8b9b0

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : CreateResource_resp.java
 ...
 * @version 1.0
 */
public class CreateResource_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public CreateResource_resp(CreateResource_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(CreateResource_resp object) {
     ...
     * @param    resourceUri    
     */
    public CreateResource_resp(String resourceUri) {
    ...
    public String toString() {
        return this.toXML("CreateResource_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CreateResource_resp)) {
            return false;
        }
        CreateResource_resp value = (CreateResource_resp)obj;
     ...
     */
    public static boolean equals(CreateResource_resp[] __array1,CreateResource_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'CreateResource_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"CreateResource_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<CreateResource_resp type=\"CreateResource_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</CreateResource_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new CreateResource_resp(this);
    }
    /**
