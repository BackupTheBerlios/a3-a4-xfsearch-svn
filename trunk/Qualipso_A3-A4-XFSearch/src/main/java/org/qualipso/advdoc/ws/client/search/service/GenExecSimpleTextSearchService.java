//abc1f5c6741ac8488d4c34632ce983b2

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenExecSimpleTextSearchService.java
...
/**
 * Clase base para la operación ExecSimpleTextSearch : Search RDF statements with text
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenExecSimpleTextSearchService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(ExecSimpleTextSearch_req __inbean,ExecSimpleTextSearch_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,ExecSimpleTextSearch_req __inbean,ExecSimpleTextSearch_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,ExecSimpleTextSearch_req __inbean,ServletContext context) {
