//6bd3316f1e4d1253baa90d66028ec

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetDisjointClasses_req.java
 ...
 * @version 1.0
 */
public class GetDisjointClasses_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetDisjointClasses_req(GetDisjointClasses_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetDisjointClasses_req object) {
     ...
     * @param    classUri    
     */
    public GetDisjointClasses_req(String classUri) {
    ...
    public String toString() {
        return this.toXML("GetDisjointClasses_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetDisjointClasses_req)) {
            return false;
        }
        GetDisjointClasses_req value = (GetDisjointClasses_req)obj;
     ...
     */
    public static boolean equals(GetDisjointClasses_req[] __array1,GetDisjointClasses_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetDisjointClasses_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetDisjointClasses_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetDisjointClasses_req type=\"GetDisjointClasses_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetDisjointClasses_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetDisjointClasses_req(this);
    }
    /**
