//aa8ee2131e885117f4bfe7929157e05c

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenExecQueryService.java
...
/**
 * Clase base para la operación ExecQuery : Execute a query on RDF model. It builds the SPARQL sentence from parameters
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenExecQueryService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(ExecQuery_req __inbean,ExecQuery_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,ExecQuery_req __inbean,ExecQuery_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,ExecQuery_req __inbean,ServletContext context) {
