//f7d49b04a12c1e5f45495b378bcbff0

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetSuperClassesService.java
...
/**
 * Clase base para la operación GetSuperClasses : Get superclasses of a given class
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetSuperClassesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetSuperClasses_req __inbean,GetSuperClasses_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetSuperClasses_req __inbean,GetSuperClasses_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetSuperClasses_req __inbean,ServletContext context) {
