//c4d8be5dd1148b61a5438a3a49e6353

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetPropertyRange_req.java
 ...
 * @version 1.0
 */
public class GetPropertyRange_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetPropertyRange_req(GetPropertyRange_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetPropertyRange_req object) {
     ...
     * @param    propertyUri    
     */
    public GetPropertyRange_req(String propertyUri) {
    ...
    public String toString() {
        return this.toXML("GetPropertyRange_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetPropertyRange_req)) {
            return false;
        }
        GetPropertyRange_req value = (GetPropertyRange_req)obj;
     ...
     */
    public static boolean equals(GetPropertyRange_req[] __array1,GetPropertyRange_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetPropertyRange_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetPropertyRange_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetPropertyRange_req type=\"GetPropertyRange_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetPropertyRange_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetPropertyRange_req(this);
    }
    /**
