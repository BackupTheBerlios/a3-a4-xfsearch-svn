//5fe44bb165c380d928cd55efeb6ef5e

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetDatatypePropertiesService.java
...
/**
 * Clase base para la operación GetDatatypeProperties : Get all datatype properties of a given class
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetDatatypePropertiesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetDatatypeProperties_req __inbean,GetDatatypeProperties_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetDatatypeProperties_req __inbean,GetDatatypeProperties_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetDatatypeProperties_req __inbean,ServletContext context) {
