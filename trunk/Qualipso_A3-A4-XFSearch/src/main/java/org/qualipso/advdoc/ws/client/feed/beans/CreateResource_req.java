//e6fffa28c2d67c3c51ea921f95401c1c

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : CreateResource_req.java
 ...
 * @version 1.0
 */
public class CreateResource_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public CreateResource_req(CreateResource_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(CreateResource_req object) {
     ...
     * @param    resourceUri    
     */
    public CreateResource_req(String resourceUri) {
    ...
    public String toString() {
        return this.toXML("CreateResource_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CreateResource_req)) {
            return false;
        }
        CreateResource_req value = (CreateResource_req)obj;
     ...
     */
    public static boolean equals(CreateResource_req[] __array1,CreateResource_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'CreateResource_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"CreateResource_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<CreateResource_req type=\"CreateResource_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</CreateResource_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new CreateResource_req(this);
    }
    /**
