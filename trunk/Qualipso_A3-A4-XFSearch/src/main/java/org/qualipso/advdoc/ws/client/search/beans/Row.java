//58ca1412830b456e95955cfc5a07e3e
...
/**
 * 
 * @composed 1 - 0..* org.qualipso.advdoc.ws.client.search.beans.Node
 * @author FRAWA
 * @version 1.0
 */
public class Row extends java.util.Observable implements es.tid.serial.TdiBean {

    // Atributos del bean

    /**
     *  ( org.qualipso.advdoc.ws.client.search.beans.Node[] )
     * @composed org.qualipso.advdoc.ws.client.search.beans.Node
     */
    protected ObjectVector nodes = new ObjectVector(10);
     ...
     * @param    object    Objeto a copiar
     */
    public void set(Row object) {
        this.nodes.clear();
        for (int i = 0;i < object.nodes.size();i++) {
            addNodes(new org.qualipso.advdoc.ws.client.search.beans.Node(object.getNodes(i)));
        }
        setChanged();
    }
     ...
     * @param    nodes    
     */
    public Row(org.qualipso.advdoc.ws.client.search.beans.Node[] nodes) {
        for (int __i = 0;__i < nodes.length;__i++) {
            addNodes(nodes[__i]);
        }
    }
    ...
    public boolean valida(java.util.ArrayList errores) {
        ...
        for (int i = 0;i < this.nodes_size();i++) {
            ok = ok && this.getNodes(i).valida(errores);
        }
        return ok;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Row value = (Row)obj;
        if (value.nodes.size() != this.nodes.size()) {
            return false;
        }
        for (int i = 0;i < value.nodes.size();i++) {
            if (!(value.getNodes(i).equals(this.getNodes(i)))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo nodes
        for (int i = 0;i < nodes.size();i++) {
            code = tdi.gen.TdiHashcode.concat(code,this.getNodes(i));
        }
        return code;
    }
     ...
     */
    public static boolean equals(Row[] __array1,Row[] __array2) {
    ...
    /**
     * Vacia los elementos del atributo nodes
     */
    public void clearNodes() { this.nodes.clear(); setChanged(); }

    /**
     * Eliminar el elemento i-ésimo del atributo nodes
     * @param    position    Posición del elemento que se quiere eliminar
     * @return   false si no se puede eliminar
     */
public     boolean removeNodes(int position) {
        return this.nodes.remove(position);
    }

    /**
     * Número de elementos en el atributo nodes
     * @return   Número de elementos
     */
    public int nodes_size() { return this.nodes.size(); }

    /**
     * Elementos del atributo nodes
     * @return   Array de elementos
     */
    public org.qualipso.advdoc.ws.client.search.beans.Node[] getNodes() {
        return (org.qualipso.advdoc.ws.client.search.beans.Node[])this.nodes.toArray(new org.qualipso.advdoc.ws.client.search.beans.Node[this.nodes.size()]);
    }

    /**
     * Obtener el elemento i-isimo del atributo nodes
     * @param    position    Posicisn del elemento que se quiere obtener
     * @return   Elemento i-isimo
     */
    public org.qualipso.advdoc.ws.client.search.beans.Node getNodes(int position) {
        return (org.qualipso.advdoc.ws.client.search.beans.Node)this.nodes.elementAt(position);
    }

    /**
     * Modificar el elemento i-isimo del atributo nodes
     * @param    position    Posicisn del elemento que se quiere modificar
     * @param    valor    Nuevo elemento
     */
    public void setNodes(int position,org.qualipso.advdoc.ws.client.search.beans.Node valor) {
        if (valor == null) {
            valor = new org.qualipso.advdoc.ws.client.search.beans.Node();
        }
        this.nodes.setElementAt(valor, position);
        setChanged();
    }

    /**
     * Modifica todos los elementos del atributo nodes
     * @param    valores    Los nuevos elementos
     */
    public void setNodes(org.qualipso.advdoc.ws.client.search.beans.Node[] valores) {
        this.nodes = new ObjectVector(valores);
        this.nodes.addObserver(this);
        setChanged();
    }

    /**
     * Aqade un nuevo elemento al atributo nodes
     * @param    valor    Nuevo elemento
     */
    public void addNodes(org.qualipso.advdoc.ws.client.search.beans.Node valor) {
        if (valor == null) {
            valor = new org.qualipso.advdoc.ws.client.search.beans.Node();
        }
        this.nodes.addElement(valor);
        setChanged();
    }
    ...
    public void fillSampleData() {
        this.nodes.clear();
        org.qualipso.advdoc.ws.client.search.beans.Node v_0_1 = new org.qualipso.advdoc.ws.client.search.beans.Node();
        v_0_1.fillSampleData();
        this.addNodes(v_0_1);
        org.qualipso.advdoc.ws.client.search.beans.Node v_0_2 = new org.qualipso.advdoc.ws.client.search.beans.Node();
  ...
  public void serialize(TdiOutputSerializer output) {
    output.append((int)this.nodes.size());
    for (int i=0; i<this.nodes.size(); i++) {
      output.append((org.qualipso.advdoc.ws.client.search.beans.Node)this.nodes.elementAt(i));
    }
  }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    {
        ...
        this.nodes = new ObjectVector(len);
        this.nodes.addObserver(this);
        for (int i = 0; i < len; i++) {
          org.qualipso.advdoc.ws.client.search.beans.Node aux = new org.qualipso.advdoc.ws.client.search.beans.Node();
          input.extract_object(aux);
          this.nodes.addElement(aux);
        }
    }
    setChanged();
  }
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'Row';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.search.beans';\n");
    }
    js.append(varName+".nodes = new Array("+this.nodes.size()+");\n");
    for (int i = 0;i < this.nodes.size();i++) {
        TdiJavascriptable object = (TdiJavascriptable)this.nodes.elementAt(i);
        js.append(object.toJS(false,true,varName+".nodes["+i+"]",0));
    }
    return js.toString();
  }
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"Row\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<Row type=\"Row\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    xml.append(_indentar(indents+1)+"<nodes type=\"org.qualipso.advdoc.ws.client.search.beans.Node[]\" size=\""+this.nodes.size()+"\">");
    xml.append("\n");
    for (int i=0; i<this.nodes.size(); i++) {
        String sufijo = (ponerIndicesDeArrays ? ""+i : "elemento");
      xml.append(((org.qualipso.advdoc.ws.client.search.beans.Node)nodes.elementAt(i)).toXML("nodes"+"_"+sufijo, indents+2,ponerIndicesDeArrays,escaparStrings));
      xml.append("\n");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</Row>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    java.util.Vector __vector_nodes = new java.util.Vector();
    for (int __i__ = 0;__i__ < nodes.size();__i__++) {
        org.qualipso.advdoc.ws.client.search.beans.Node __object__ = (org.qualipso.advdoc.ws.client.search.beans.Node)nodes.elementAt(__i__);
        __vector_nodes.addElement(__object__.toRPC());
    }
    __struct__.put("nodes",__vector_nodes);
    return __struct__;
  }
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_nodes = __params__.get("nodes");
    if (__object_nodes == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo vector nodes");
    }
    if (!(__object_nodes instanceof java.util.Vector)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo nodes no es de tipo Vector");
    }
    java.util.Vector __vector_nodes = (java.util.Vector)__object_nodes;
    for (int i = 0;i < __vector_nodes.size();i++) {
        Object __element__ = __vector_nodes.elementAt(i);
        if (!(__element__ instanceof java.util.Hashtable)) {
            throw new Exception(getClass().getName()+".fromRPC() El atributo nodes no es de tipo Hashtable");
        }
        java.util.Hashtable __hashtable__ = (java.util.Hashtable)__element__;
        org.qualipso.advdoc.ws.client.search.beans.Node __value__;
        ...
        if (__constructor__ == null || __constructor__.equals("")) {
            __value__ = new org.qualipso.advdoc.ws.client.search.beans.Node();
        } else {
            __value__ = (org.qualipso.advdoc.ws.client.search.beans.Node)Class.forName(__constructor__).newInstance();
        }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      ...
      org.w3c.dom.Element __element = getNodeByName(__node,"nodes");
      int __size = 0;
      if (__element != null) {
      ...
      for (int i = 0;i < __size;i++) {
        org.w3c.dom.Element __element2 = getNodeByName(__element,"nodes_"+i);
        org.qualipso.advdoc.ws.client.search.beans.Node __entry;
        if (__element2.getAttribute("package") != null && __element2.getAttribute("package").length() != 0) {
          __entry = (org.qualipso.advdoc.ws.client.search.beans.Node) Class.forName(__element2.getAttribute("package")+"."+__element2.getAttribute("type")).newInstance();
        } else {
          __entry = new org.qualipso.advdoc.ws.client.search.beans.Node();
        }
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("nodes");
        if (node != null && node.getContents() != null) {

            arrayNodes = node.getChildsByName("Node");
            if (arrayNodes != null) {
                this.clearNodes();
                for (int i = 0;i < arrayNodes.length;i++) {
                    if (arrayNodes[i] != null && arrayNodes[i].getContents() != null) {
                        org.qualipso.advdoc.ws.client.search.beans.Node tmp = new org.qualipso.advdoc.ws.client.search.beans.Node();
    ...
    public void toJSON(JSONObject json) throws JSONException {
        ...
        for (int i = 0;i < nodes_size();i++) {
            ...
            this.getNodes(i).toJSON(jObj_i);
            jObjectArray.put(jObj_i);
        }
        json.put("nodes",jObjectArray);
    }
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        JSONArray jArray;
        JSONArray jObjectArray;
        jObjectArray = json.getJSONArray("nodes");
        this.clearNodes();
