//63e45c6e42754627b2a565ac115eebe

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetSubPropertiesService.java
...
/**
 * Clase base para la operación GetSubProperties : Get subproperties of a given property
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetSubPropertiesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetSubProperties_req __inbean,GetSubProperties_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetSubProperties_req __inbean,GetSubProperties_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetSubProperties_req __inbean,ServletContext context) {
