//4d46a19c499a625ece3f25c2084baf1

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenBuildSPARQLSearchService.java
...
/**
 * Clase base para la operación BuildSPARQLSearch : Build a SPARQL query string from query components (including text search)
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenBuildSPARQLSearchService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(org.qualipso.advdoc.ws.client.search.beans.ExecSearch_req __inbean,org.qualipso.advdoc.ws.client.search.beans.BuildSPARQLSearch_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,org.qualipso.advdoc.ws.client.search.beans.ExecSearch_req __inbean,org.qualipso.advdoc.ws.client.search.beans.BuildSPARQLSearch_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,org.qualipso.advdoc.ws.client.search.beans.ExecSearch_req __inbean,ServletContext context) {
