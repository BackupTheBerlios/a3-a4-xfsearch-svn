//2ba575e2e484c808f188de36949ad9

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenBuildSPARQLQueryService.java
...
/**
 * Clase base para la operación BuildSPARQLQuery : Build a SPARQL query string from query components
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenBuildSPARQLQueryService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(org.qualipso.advdoc.ws.client.search.beans.ExecQuery_req __inbean,org.qualipso.advdoc.ws.client.search.beans.BuildSPARQLQuery_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,org.qualipso.advdoc.ws.client.search.beans.ExecQuery_req __inbean,org.qualipso.advdoc.ws.client.search.beans.BuildSPARQLQuery_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,org.qualipso.advdoc.ws.client.search.beans.ExecQuery_req __inbean,ServletContext context) {
