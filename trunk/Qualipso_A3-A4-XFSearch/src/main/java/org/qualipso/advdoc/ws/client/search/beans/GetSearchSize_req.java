//6adcfa78c6aa253fe74e2997fe6b5f

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetSearchSize_req.java
 ...
 * @version 1.0
 */
public class GetSearchSize_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetSearchSize_req(GetSearchSize_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetSearchSize_req object) {
     ...
     * @param    searchText    
     */
    public GetSearchSize_req(String searchText) {
    ...
    public String toString() {
        return this.toXML("GetSearchSize_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetSearchSize_req)) {
            return false;
        }
        GetSearchSize_req value = (GetSearchSize_req)obj;
     ...
     */
    public static boolean equals(GetSearchSize_req[] __array1,GetSearchSize_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetSearchSize_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetSearchSize_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetSearchSize_req type=\"GetSearchSize_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetSearchSize_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetSearchSize_req(this);
    }
    /**
