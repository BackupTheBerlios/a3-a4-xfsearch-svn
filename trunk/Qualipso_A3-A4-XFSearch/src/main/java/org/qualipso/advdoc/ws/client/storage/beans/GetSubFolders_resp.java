//d73acde6b82c505f765250b4857cbe54

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetSubFolders_resp.java
 ...
 * @version 1.0
 */
public class GetSubFolders_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetSubFolders_resp(GetSubFolders_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetSubFolders_resp object) {
     ...
     * @param    folders    
     */
    public GetSubFolders_resp(String[] folders) {
    ...
    public String toString() {
        return this.toXML("GetSubFolders_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetSubFolders_resp)) {
            return false;
        }
        GetSubFolders_resp value = (GetSubFolders_resp)obj;
     ...
     */
    public static boolean equals(GetSubFolders_resp[] __array1,GetSubFolders_resp[] __array2) {
...
public     boolean removeFolders(int position) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetSubFolders_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetSubFolders_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetSubFolders_resp type=\"GetSubFolders_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetSubFolders_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetSubFolders_resp(this);
    }
    /**
