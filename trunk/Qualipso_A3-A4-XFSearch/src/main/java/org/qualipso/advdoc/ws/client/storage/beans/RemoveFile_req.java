//ce62706616e80ab67bf8f5c261bc25

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : RemoveFile_req.java
 ...
 * @version 1.0
 */
public class RemoveFile_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public RemoveFile_req(RemoveFile_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(RemoveFile_req object) {
        setFile(object.getFile());
     ...
     * @param    path    
     */
    public RemoveFile_req(org.qualipso.advdoc.ws.client.storage.beans.FolderPath path,String file) {
        setFile(file);
        setPath(path);
    }
    ...
    public String toString() {
        return this.toXML("RemoveFile_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RemoveFile_req)) {
            return false;
        }
        RemoveFile_req value = (RemoveFile_req)obj;
        if (!(value.file.equals(this.file))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        int code = 7;
        // Concatenar con el hashcode del atributo file
        code = tdi.gen.TdiHashcode.concat(code,this.file);
     ...
     */
    public static boolean equals(RemoveFile_req[] __array1,RemoveFile_req[] __array2) {
    ...
    /**
     * Lectura del atributo file
     * @return   Valor del atributo file
     */
    public String getFile() { return this.file; }

    /**
     * Escritura del atributo file
     * @param    valor    Nuevo valor del atributo file
     */
    public void setFile(String valor) { 
        if (valor == null) {
            valor = new String();
        }
        this.file = valor;
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.file = input.extract_String();
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'RemoveFile_req';\n");
        js.append(varName+".__package__ = 'org.qualipso.advdoc.ws.client.storage.beans';\n");
    }
    js.append(varName+".file = '"+es.tid.serial.TdiSerialUtil.escapaJavascript(this.file)+"';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"RemoveFile_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<RemoveFile_req type=\"RemoveFile_req\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    if (escaparStrings) {
        xml.append(_indentar(indents+1)+"<file type=\"string\">"+tdi.text.StringUtil.escapeXML(this.file,false)+"</file>");
    } else {
        xml.append(_indentar(indents+1)+"<file type=\"string\">"+this.file+"</file>");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</RemoveFile_req>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    __struct__.put("file", tdi.text.StringUtil.sustituyeUnicode(this.file));
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    Object __object_file = __params__.get("file");
    if (__object_file == null) {
        throw new Exception(getClass().getName()+".fromRPC() No se encuentra el atributo file");
    }
    if (!(__object_file instanceof String)) {
        throw new Exception(getClass().getName()+".fromRPC() El atributo file no es de tipo String");
    }
    setFile((String)__object_file);
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    {
      String __v = "";
      org.w3c.dom.Element __e = getNodeByName(__node,"file");
    ...
    public void toSOAP(java.io.Writer writer) throws java.io.IOException {
        writer.write("<file>");
        writer.write(tdi.text.StringUtil.escapeXML(this.getFile(), false));
        writer.write("</file>");
        writer.write("\n");
        writer.write("<path>");
    ...
    public void fromSOAP(tdi.xml.parser.TdiXmlNode beanNode) {
        ...
        node = beanNode.getFirstChildByName("file");
        if (node != null && node.getContents() != null) {
            this.setFile(node.getContents());
        }
    ...
    public void fromJSON(JSONObject json) throws JSONException {
        this.setFile(json.getString("file"));
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new RemoveFile_req(this);
    }
    /**
