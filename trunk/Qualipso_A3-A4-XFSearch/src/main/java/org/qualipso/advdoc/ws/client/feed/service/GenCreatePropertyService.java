//8ab6d9f2633c7e18cd6f6dfbf21b153

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenCreatePropertyService.java
...
/**
 * Clase base para la operación CreateProperty : Creates a new property
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenCreatePropertyService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(CreateProperty_req __inbean,CreateProperty_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,CreateProperty_req __inbean,CreateProperty_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,CreateProperty_req __inbean,ServletContext context) {
