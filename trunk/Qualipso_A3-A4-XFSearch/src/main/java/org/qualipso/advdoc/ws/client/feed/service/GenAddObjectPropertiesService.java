//41346fdf05e568cb0a0661577fa76b

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenAddObjectPropertiesService.java
...
/**
 * Clase base para la operación AddObjectProperties : Add some object properties to an existing resource
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenAddObjectPropertiesService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(AddObjectProperties_req __inbean,AddObjectProperties_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,AddObjectProperties_req __inbean,AddObjectProperties_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,AddObjectProperties_req __inbean,ServletContext context) {
