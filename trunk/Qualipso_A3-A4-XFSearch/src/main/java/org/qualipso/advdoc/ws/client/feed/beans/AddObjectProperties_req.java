//f06c4fefb69fb5e7d41fad37ad63b5dc

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : AddObjectProperties_req.java
...
/**
 * 
 * @composed 1 - 0..* org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty
 * @author FRAWA
 * @version 1.0
 */
public class AddObjectProperties_req extends java.util.Observable implements es.tid.serial.TdiBean {
    ...
    /**
     *  ( org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty[] )
     * @composed org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty
     */
     ...
     */
    public AddObjectProperties_req() {
     ...
     */
    public AddObjectProperties_req(AddObjectProperties_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(AddObjectProperties_req object) {
        setResourceUri(object.getResourceUri());
        this.objectProperties.clear();
        for (int i = 0;i < object.objectProperties.size();i++) {
            addObjectProperties(new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty(object.getObjectProperties(i)));
        }
        setChanged();
    }
     ...
     */
    public AddObjectProperties_req(String resourceUri,org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty[] objectProperties) {
    ...
    public String toString() {
        return this.toXML("AddObjectProperties_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof AddObjectProperties_req)) {
            return false;
        }
        AddObjectProperties_req value = (AddObjectProperties_req)obj;
     ...
     */
    public static boolean equals(AddObjectProperties_req[] __array1,AddObjectProperties_req[] __array2) {
    ...
    /**
     * Eliminar el elemento i-ésimo del atributo objectProperties
...
public     boolean removeObjectProperties(int position) {
    ...
    /**
     * Número de elementos en el atributo objectProperties
     ...
     */
    public org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty[] getObjectProperties() {
        return (org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty[])this.objectProperties.toArray(new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty[this.objectProperties.size()]);
    }
     ...
     */
    public org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty getObjectProperties(int position) {
        return (org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty)this.objectProperties.elementAt(position);
    }
     ...
     */
    public void setObjectProperties(int position,org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty valor) {
        if (valor == null) {
            valor = new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty();
        }
     ...
     */
    public void setObjectProperties(org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty[] valores) {
     ...
     * @param    valor    Nuevo elemento
     */
    public void addObjectProperties(org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty valor) {
        if (valor == null) {
            valor = new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty();
        }
    ...
    public void fillSampleData() {
        ...
        this.objectProperties.clear();
        org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty v_0_1 = new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty();
        v_0_1.fillSampleData();
        this.addObjectProperties(v_0_1);
        org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty v_0_2 = new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty();
        v_0_2.fillSampleData();
        this.addObjectProperties(v_0_2);
    }
  ...
  public void serialize(TdiOutputSerializer output) {
    ...
    for (int i=0; i<this.objectProperties.size(); i++) {
      output.append((org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty)this.objectProperties.elementAt(i));
    }
  }
  ...
  public void deserialize(TdiInputSerializer input) throws Exception {
    this.resourceUri = input.extract_String();
    {
        ...
        this.objectProperties.addObserver(this);
        for (int i = 0; i < len; i++) {
          org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty aux = new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty();
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'AddObjectProperties_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"AddObjectProperties_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<AddObjectProperties_req type=\"AddObjectProperties_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    xml.append("\n");
    xml.append(_indentar(indents+1)+"<objectProperties type=\"org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty[]\" size=\""+this.objectProperties.size()+"\">");
    xml.append("\n");
    for (int i=0; i<this.objectProperties.size(); i++) {
        String sufijo = (ponerIndicesDeArrays ? ""+i : "elemento");
      xml.append(((org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty)objectProperties.elementAt(i)).toXML("objectProperties"+"_"+sufijo, indents+2,ponerIndicesDeArrays,escaparStrings));
      xml.append("\n");
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</AddObjectProperties_req>");
    }
    return xml.toString();
  }
  ...
  protected Object toRPC(java.util.Hashtable __struct__) {
    ...
    for (int __i__ = 0;__i__ < objectProperties.size();__i__++) {
        org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty __object__ = (org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty)objectProperties.elementAt(__i__);
  ...
  public void fromRPC(java.util.Hashtable __params__) throws Exception {
    ...
    for (int i = 0;i < __vector_objectProperties.size();i++) {
        ...
        org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty __value__;
        ...
        if (__constructor__ == null || __constructor__.equals("")) {
            __value__ = new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty();
        } else {
            __value__ = (org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty)Class.forName(__constructor__).newInstance();
        }
  ...
  public void fromXML(org.w3c.dom.Element __node) throws Exception {
    ...
    }
    {
      ...
      for (int i = 0;i < __size;i++) {
        ...
        org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty __entry;
        if (__element2.getAttribute("package") != null && __element2.getAttribute("package").length() != 0) {
          __entry = (org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty) Class.forName(__element2.getAttribute("package")+"."+__element2.getAttribute("type")).newInstance();
        } else {
          __entry = new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty();
        }
            ...
            if (arrayNodes != null) {
                ...
                for (int i = 0;i < arrayNodes.length;i++) {
                    if (arrayNodes[i] != null && arrayNodes[i].getContents() != null) {
                        org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty tmp = new org.qualipso.advdoc.ws.client.feed.beans.ObjectProperty();
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new AddObjectProperties_req(this);
    }
    /**
