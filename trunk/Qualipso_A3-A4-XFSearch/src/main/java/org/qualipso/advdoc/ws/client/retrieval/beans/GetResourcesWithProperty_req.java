//a51be266c3b692b7697a4dd136f70bc

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetResourcesWithProperty_req.java
 ...
 * @version 1.0
 */
public class GetResourcesWithProperty_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetResourcesWithProperty_req() {
     ...
     */
    public GetResourcesWithProperty_req(GetResourcesWithProperty_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetResourcesWithProperty_req object) {
     ...
     * @param    propertyUri    
     */
    public GetResourcesWithProperty_req(String propertyUri) {
    ...
    public String toString() {
        return this.toXML("GetResourcesWithProperty_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetResourcesWithProperty_req)) {
            return false;
        }
        GetResourcesWithProperty_req value = (GetResourcesWithProperty_req)obj;
     ...
     */
    public static boolean equals(GetResourcesWithProperty_req[] __array1,GetResourcesWithProperty_req[] __array2) {
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "GetResourcesWithProperty_req <BR>",
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetResourcesWithProperty_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetResourcesWithProperty_req\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetResourcesWithProperty_req type=\"GetResourcesWithProperty_req\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetResourcesWithProperty_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetResourcesWithProperty_req(this);
    }
    /**
    ...
    public void copyFrom(Object source) throws ClassCastException {
        if (!(source instanceof GetResourcesWithProperty_req)) {
            throw new ClassCastException(getClass().getName()+".copyFrom() El objeto de copia es de la clase "+source.getClass().getName());
        }
        GetResourcesWithProperty_req bean = (GetResourcesWithProperty_req)source;
        this.set(bean);
    }
