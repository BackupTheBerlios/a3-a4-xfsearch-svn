//49526cee38eb7de22b748c62b1affb1f

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : CreateProperty_resp.java
 ...
 * @version 1.0
 */
public class CreateProperty_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public CreateProperty_resp(CreateProperty_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(CreateProperty_resp object) {
     ...
     * @param    propertyUri    
     */
    public CreateProperty_resp(String propertyUri) {
    ...
    public String toString() {
        return this.toXML("CreateProperty_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CreateProperty_resp)) {
            return false;
        }
        CreateProperty_resp value = (CreateProperty_resp)obj;
     ...
     */
    public static boolean equals(CreateProperty_resp[] __array1,CreateProperty_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'CreateProperty_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"CreateProperty_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<CreateProperty_resp type=\"CreateProperty_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</CreateProperty_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new CreateProperty_resp(this);
    }
    /**
