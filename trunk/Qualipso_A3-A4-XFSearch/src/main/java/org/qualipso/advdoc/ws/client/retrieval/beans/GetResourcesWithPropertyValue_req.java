//17338ec2dddf2f8e4f2accfb232063fc

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetResourcesWithPropertyValue_req.java
 ...
 * @version 1.0
 */
public class GetResourcesWithPropertyValue_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetResourcesWithPropertyValue_req() {
     ...
     */
    public GetResourcesWithPropertyValue_req(GetResourcesWithPropertyValue_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetResourcesWithPropertyValue_req object) {
     ...
     * @param    value    
     */
    public GetResourcesWithPropertyValue_req(String propertyUri,String value) {
    ...
    public String toString() {
        return this.toXML("GetResourcesWithPropertyValue_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetResourcesWithPropertyValue_req)) {
            return false;
        }
        GetResourcesWithPropertyValue_req value = (GetResourcesWithPropertyValue_req)obj;
     ...
     */
    public static boolean equals(GetResourcesWithPropertyValue_req[] __array1,GetResourcesWithPropertyValue_req[] __array2) {
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetResourcesWithPropertyValue_req\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetResourcesWithPropertyValue_req type=\"GetResourcesWithPropertyValue_req\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetResourcesWithPropertyValue_req(this);
    }
    /**
    ...
    public void copyFrom(Object source) throws ClassCastException {
        if (!(source instanceof GetResourcesWithPropertyValue_req)) {
            throw new ClassCastException(getClass().getName()+".copyFrom() El objeto de copia es de la clase "+source.getClass().getName());
        }
        GetResourcesWithPropertyValue_req bean = (GetResourcesWithPropertyValue_req)source;
        this.set(bean);
    }
