//3481bf961ffc0e916b2ed8fcb5cac

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenRemoveFolderService.java
...
/**
 * Clase base para la operación RemoveFolder : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenRemoveFolderService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(RemoveFolder_req __inbean,RemoveFolder_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,RemoveFolder_req __inbean,RemoveFolder_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,RemoveFolder_req __inbean,ServletContext context) {
