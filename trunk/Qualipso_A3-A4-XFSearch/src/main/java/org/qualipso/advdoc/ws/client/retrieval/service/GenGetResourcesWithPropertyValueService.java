//8a5a118e63664544ae4fe64e1d38cc6

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenGetResourcesWithPropertyValueService.java
...
/**
 * Clase base para la operación GetResourcesWithPropertyValue : Get resources with a property with a given value
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenGetResourcesWithPropertyValueService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(GetResourcesWithPropertyValue_req __inbean,GetResourcesWithPropertyValue_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,GetResourcesWithPropertyValue_req __inbean,GetResourcesWithPropertyValue_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,GetResourcesWithPropertyValue_req __inbean,ServletContext context) {
