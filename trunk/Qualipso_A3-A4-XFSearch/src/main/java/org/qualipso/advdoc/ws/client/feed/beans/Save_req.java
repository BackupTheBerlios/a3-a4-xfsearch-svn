//ece34b3c4bd59967fbc93f523d94538

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : Save_req.java
 ...
 * @version 1.0
 */
public class Save_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public Save_req(Save_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(Save_req object) {
     ...
     * @param    filename    
     */
    public Save_req(String filename) {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof Save_req)) {
            return false;
        }
        Save_req value = (Save_req)obj;
     ...
     */
    public static boolean equals(Save_req[] __array1,Save_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'Save_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"Save_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<Save_req type=\"Save_req\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</Save_req>");
    }
    return xml.toString();
  }
