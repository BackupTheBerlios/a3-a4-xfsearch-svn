//e76e241921ebd9274f63a584f4cf7b

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetSubProperties_req.java
 ...
 * @version 1.0
 */
public class GetSubProperties_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetSubProperties_req(GetSubProperties_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetSubProperties_req object) {
     ...
     * @param    propertyUri    
     */
    public GetSubProperties_req(String propertyUri,int direct) {
        setDirect(direct);
    ...
    public String toString() {
        return this.toXML("GetSubProperties_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetSubProperties_req)) {
            return false;
        }
        GetSubProperties_req value = (GetSubProperties_req)obj;
     ...
     */
    public static boolean equals(GetSubProperties_req[] __array1,GetSubProperties_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'GetSubProperties_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetSubProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetSubProperties_req type=\"GetSubProperties_req\" package=\"org.qualipso.advdoc.ws.client.metadata.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</GetSubProperties_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetSubProperties_req(this);
    }
    /**
