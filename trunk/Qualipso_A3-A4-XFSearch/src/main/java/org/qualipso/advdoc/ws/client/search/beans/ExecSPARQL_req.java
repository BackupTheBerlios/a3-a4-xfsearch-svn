//c38973171523e215615bd8363824660

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ExecSPARQL_req.java
 ...
 * @version 1.0
 */
public class ExecSPARQL_req extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public ExecSPARQL_req(ExecSPARQL_req object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ExecSPARQL_req object) {
     ...
     * @param    sparql    
     */
    public ExecSPARQL_req(String sparql) {
        setSparql(sparql);
    }
    ...
    public String toString() {
        return this.toXML("ExecSPARQL_req",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ExecSPARQL_req)) {
            return false;
        }
        ExecSPARQL_req value = (ExecSPARQL_req)obj;
     ...
     */
    public static boolean equals(ExecSPARQL_req[] __array1,ExecSPARQL_req[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ExecSPARQL_req';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ExecSPARQL_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ExecSPARQL_req type=\"ExecSPARQL_req\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ExecSPARQL_req>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new ExecSPARQL_req(this);
    }
    /**
