//eef654cfc3dfeb574e93e4226716791

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : GetResourceProperty_resp.java
 ...
 * @version 1.0
 */
public class GetResourceProperty_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public GetResourceProperty_resp() {
     ...
     */
    public GetResourceProperty_resp(GetResourceProperty_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(GetResourceProperty_resp object) {
     ...
     */
    public GetResourceProperty_resp(org.qualipso.advdoc.ws.client.retrieval.beans.LiteralProperty[] literalProperties,org.qualipso.advdoc.ws.client.retrieval.beans.ObjectProperty[] objectProperties) {
    ...
    public String toString() {
        return this.toXML("GetResourceProperty_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof GetResourceProperty_resp)) {
            return false;
        }
        GetResourceProperty_resp value = (GetResourceProperty_resp)obj;
     ...
     */
    public static boolean equals(GetResourceProperty_resp[] __array1,GetResourceProperty_resp[] __array2) {
...
public     boolean removeObjectProperties(int position) {
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"GetResourceProperty_resp\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<GetResourceProperty_resp type=\"GetResourceProperty_resp\" package=\"org.qualipso.advdoc.ws.client.retrieval.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new GetResourceProperty_resp(this);
    }
    /**
