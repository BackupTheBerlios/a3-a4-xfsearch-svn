//52b9405d187da5f624a63a51e2f2c1b

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenCreateAnonymousResourceService.java
...
/**
 * Clase base para la operación CreateAnonymousResource : Creates a new anonymous resource
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenCreateAnonymousResourceService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(CreateAnonymousResource_req __inbean,CreateAnonymousResource_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,CreateAnonymousResource_req __inbean,CreateAnonymousResource_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,CreateAnonymousResource_req __inbean,ServletContext context) {
