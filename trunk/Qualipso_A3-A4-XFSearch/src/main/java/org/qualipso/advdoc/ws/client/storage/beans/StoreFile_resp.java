//a0c0a9e57d469542a3c67f98d7dfb

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : StoreFile_resp.java
 ...
 * @version 1.0
 */
public class StoreFile_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public StoreFile_resp(StoreFile_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(StoreFile_resp object) {
     ...
     * @param    result    
     */
    public StoreFile_resp(int result) {
        setResult(result);
    }
    ...
    public String toString() {
        return this.toXML("StoreFile_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof StoreFile_resp)) {
            return false;
        }
        StoreFile_resp value = (StoreFile_resp)obj;
     ...
     */
    public static boolean equals(StoreFile_resp[] __array1,StoreFile_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'StoreFile_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"StoreFile_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<StoreFile_resp type=\"StoreFile_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</StoreFile_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new StoreFile_resp(this);
    }
    /**
