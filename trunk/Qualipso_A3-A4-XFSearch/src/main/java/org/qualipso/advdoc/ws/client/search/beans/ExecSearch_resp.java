//48cbb17bdd74644df23ff98a9f634991

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : ExecSearch_resp.java
 ...
 * @version 1.0
 */
public class ExecSearch_resp extends org.qualipso.advdoc.ws.client.search.beans.ExecQuery_resp implements es.tid.serial.TdiBean {
     ...
     */
    public ExecSearch_resp(ExecSearch_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(ExecSearch_resp object) {
        super.set(object);
        setChanged();
    }
     ...
     */
    public ExecSearch_resp(org.qualipso.advdoc.ws.client.search.beans.SPARQLResult result,String sparql,double time) {
    ...
    public String toString() {
        return this.toXML("ExecSearch_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ExecSearch_resp)) {
            return false;
        }
        ExecSearch_resp value = (ExecSearch_resp)obj;
        if (!super.equals(obj)) {
            return false;
        }
        return true;
     ...
     */
    public static boolean equals(ExecSearch_resp[] __array1,ExecSearch_resp[] __array2) {
    ...
    public static String getStructure() {
        if (estructura == null) {
            String[] lines = new String[] {
                "ExecSearch_resp  extends ExecQuery_resp<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;string sparql (*)<BR>",
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;double time (*)<BR>",
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'ExecSearch_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"ExecSearch_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<ExecSearch_resp type=\"ExecSearch_resp\" package=\"org.qualipso.advdoc.ws.client.search.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</ExecSearch_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new ExecSearch_resp(this);
    }
    /**
