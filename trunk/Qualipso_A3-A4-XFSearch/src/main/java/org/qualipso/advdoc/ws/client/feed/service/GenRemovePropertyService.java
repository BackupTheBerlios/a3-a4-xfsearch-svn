//fc1c32e141ac27901bf382db1e81d1

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenRemovePropertyService.java
...
/**
 * Clase base para la operación RemoveProperty : Remove all sentences with a property for a given resource
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenRemovePropertyService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(RemoveProperty_req __inbean,RemoveProperty_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,RemoveProperty_req __inbean,RemoveProperty_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,RemoveProperty_req __inbean,ServletContext context) {
