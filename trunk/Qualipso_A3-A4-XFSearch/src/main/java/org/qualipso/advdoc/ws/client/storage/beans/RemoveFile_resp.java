//d80abf66d8ebdc66c306e6832c4b9f6

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : RemoveFile_resp.java
 ...
 * @version 1.0
 */
public class RemoveFile_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public RemoveFile_resp(RemoveFile_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(RemoveFile_resp object) {
     ...
     * @param    result    
     */
    public RemoveFile_resp(int result) {
        setResult(result);
    }
    ...
    public String toString() {
        return this.toXML("RemoveFile_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof RemoveFile_resp)) {
            return false;
        }
        RemoveFile_resp value = (RemoveFile_resp)obj;
     ...
     */
    public static boolean equals(RemoveFile_resp[] __array1,RemoveFile_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'RemoveFile_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"RemoveFile_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<RemoveFile_resp type=\"RemoveFile_resp\" package=\"org.qualipso.advdoc.ws.client.storage.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</RemoveFile_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new RemoveFile_resp(this);
    }
    /**
