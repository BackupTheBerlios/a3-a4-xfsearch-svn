//6972d8943acd4ad40488ef735193bde

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenCreateResourceService.java
...
/**
 * Clase base para la operación CreateResource : Creates a new resource
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenCreateResourceService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(CreateResource_req __inbean,CreateResource_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,CreateResource_req __inbean,CreateResource_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,CreateResource_req __inbean,ServletContext context) {
