//2dcc0ed81d0fa63ce7d32c1e1836861

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : AddObjectProperties_resp.java
 ...
 * @version 1.0
 */
public class AddObjectProperties_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public AddObjectProperties_resp() {
     ...
     */
    public AddObjectProperties_resp(AddObjectProperties_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(AddObjectProperties_resp object) {
     ...
     * @param    resourceUri    
     */
    public AddObjectProperties_resp(String resourceUri) {
    ...
    public String toString() {
        return this.toXML("AddObjectProperties_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof AddObjectProperties_resp)) {
            return false;
        }
        AddObjectProperties_resp value = (AddObjectProperties_resp)obj;
     ...
     */
    public static boolean equals(AddObjectProperties_resp[] __array1,AddObjectProperties_resp[] __array2) {
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"AddObjectProperties_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<AddObjectProperties_resp type=\"AddObjectProperties_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new AddObjectProperties_resp(this);
    }
    /**
