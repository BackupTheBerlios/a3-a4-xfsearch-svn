//d45ba4c56f781a1d1e22d326bbb1366b

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenTestParserService.java
...
/**
 * Clase base para la operación TestParser : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenTestParserService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(org.qualipso.advdoc.ws.client.storage.beans.TestParser __inbean,org.qualipso.advdoc.ws.client.storage.beans.TestParser __outbean) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,org.qualipso.advdoc.ws.client.storage.beans.TestParser __inbean,org.qualipso.advdoc.ws.client.storage.beans.TestParser __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,org.qualipso.advdoc.ws.client.storage.beans.TestParser __inbean) {
