//be788025d6318eb7bde7974c8533f79

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenReIndexService.java
...
/**
 * Clase base para la operación ReIndex : Regenerate Lucene indexes
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenReIndexService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(ReIndex_req __inbean,ReIndex_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,ReIndex_req __inbean,ReIndex_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,ReIndex_req __inbean,ServletContext context) {
