//6f45cf99afcf33b8beda5740404c5a43

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero  : AddLiteralProperty_resp.java
 ...
 * @version 1.0
 */
public class AddLiteralProperty_resp extends java.util.Observable implements es.tid.serial.TdiBean {
     ...
     */
    public AddLiteralProperty_resp() {
     ...
     */
    public AddLiteralProperty_resp(AddLiteralProperty_resp object) {
        this.set(object);
    }
     ...
     * @param    object    Objeto a copiar
     */
    public void set(AddLiteralProperty_resp object) {
     ...
     * @param    resourceUri    
     */
    public AddLiteralProperty_resp(String resourceUri) {
    ...
    public String toString() {
        return this.toXML("AddLiteralProperty_resp",0);
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof AddLiteralProperty_resp)) {
            return false;
        }
        AddLiteralProperty_resp value = (AddLiteralProperty_resp)obj;
     ...
     */
    public static boolean equals(AddLiteralProperty_resp[] __array1,AddLiteralProperty_resp[] __array2) {
  ...
  public String toJS(boolean root,boolean create,String varName,int indents) {
    ...
    if (create) {
        ...
        js.append(varName+".__constructor__ = 'AddLiteralProperty_resp';\n");
  ...
  public String toXML(String tag, int indents,boolean ponerIndicesDeArrays,boolean escaparStrings) {
    ...
    if (tag != null && tag.length() > 0) {
      xml.append(_indentar(indents)+"<"+tag+" type=\"AddLiteralProperty_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else if (tag != null && tag.length() == 0) {
      xml.append(_indentar(indents));
      xml.append("<?xml version='1.0' encoding='ISO-8859-1'?>\n");
      xml.append(_indentar(indents)+"<AddLiteralProperty_resp type=\"AddLiteralProperty_resp\" package=\"org.qualipso.advdoc.ws.client.feed.beans\">");
      xml.append("\n");
    } else {
      indents--;
    }
    ...
    if (tag != null && tag.length() > 0) {
      ...
      xml.append(_indentar(indents)+"</AddLiteralProperty_resp>");
    }
    return xml.toString();
  }
  ...
  private org.w3c.dom.Element getNodeByName(org.w3c.dom.Element parent,String name) throws Exception {
     ...
     */
    public Object clone() {
        return new AddLiteralProperty_resp(this);
    }
    /**
