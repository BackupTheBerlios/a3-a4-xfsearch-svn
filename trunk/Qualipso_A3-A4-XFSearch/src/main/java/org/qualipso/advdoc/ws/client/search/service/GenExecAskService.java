//4b50bd5dcbfa8a452ae4a34077307310

/* 1.0 */

// TDI_3971_4573_0146_8888_2525_8264_3791
//-----------------------------------------------------------------
// Fichero : GenExecAskService.java
...
/**
 * Clase base para la operación ExecAsk : 
 * @author FRAWA
 * @version 1.0
 */
public abstract class GenExecAskService extends es.tid.frawa.service.servlet.AbstractService {
     ...
     */
    public abstract void execute(ExecAsk_req __inbean,ExecAsk_resp __outbean,ServletContext context) throws Exception;
     ...
     */
    final Throwable executeImpl(HttpServlet servlet,HttpServletRequest request,HttpServletResponse response,ExecAsk_req __inbean,ExecAsk_resp __outbean) {
     ...
     */
    protected Throwable onException(Throwable t,ExecAsk_req __inbean,ServletContext context) {
